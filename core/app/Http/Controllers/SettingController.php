...
class SettingController extends Controller
{
    ...
    public function SettlementUpdate(Request $request)
    {
        ...
        if($request->vcard_max_amt)
        {
         $data->virtual_card_max_amt = $request->vcard_max_amt;
        }
        if($request->vcard_min_amt)
        {
         $data->virtual_card_min_amt = $request->vcard_min_amt;
        }
        $res=$data->save();
        if ($res) {
    ...
    public function AccountUpdate(Request $request)
    {
        ...
        /*
        $data = Admin::whereid(Auth::id())->first();
    ...
    public function Features(Request $request)
    {
        ...
        if(empty($request->mobile_verification)){
            $data->mobile_verification=0;	
        }else{
            $data->mobile_verification=$request->mobile_verification;
        }  
    ...
    public function charges(Request $request)
    {
        ...
        $data->physical_card=$request->physical_card; 
        $res=$data->save();
        if ($res) {
            return back()->with('success', 'Update was Successful!');
        } else {
