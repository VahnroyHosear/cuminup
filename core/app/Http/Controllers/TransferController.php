...
class TransferController extends Controller
{
    ...
    public function sclinks()
    {
        ...
        $data['links']=Paymentlink::wheretype(11)->latest()->paginate(6);
                    ...
                    if($key->status==1){
                        if($key->active==1){
                           ...
                           $linkName = $data['link']->name;
                            ...
                            if(!empty(Session::get('product_type_id')))
                            {
                             $data['productTypeDetails'] = DB::table('virtual_cards_product_type')->where('id',Session::get('product_type_id'))->first();
                            }
