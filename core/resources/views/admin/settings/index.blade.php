            ...
            <div class="card-body">
                <form action="{{route('admin.settlement.update')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="number"  pattern="[0-9]+(\.[0-9]{0,2})?%?" value="{{$set->virtual_card_min_amt}}" id="duration" name="vcard_min_amt" class="form-control" placeholder="1" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2">{{__('Card Max Amount')}}</label>
                        <div class="col-lg-10">
                            <input type="number" name="vcard_max_amt" pattern="[0-9]+(\.[0-9]{0,2})?%?" value="{{$set->virtual_card_max_amt}}" id="duration" class="form-control" placeholder="1" required>
                        </div>
                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="custom-control custom-control-alternative custom-checkbox">
                                            ...
                                            <span class="text-muted">{{__('Mobile verification')}}</span>     
                                            </label>
                                        </div> 
                                        <div class="custom-control custom-control-alternative custom-checkbox">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.charges.update')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-form-label col-lg-2">Shipping <span class="text-danger">*</span></label>
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                    ...
                                    <label class="col-form-label col-lg-2">{{__('Physical Card')}}<span class="text-danger">*</span></label>
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                            <span class="input-group-prepend">
                                                <span class="input-group-text">{{$currency->symbol}}</span>
                                            </span>
                                            <input type="number" name="physical_card" value="{{$set->physical_card}}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>                    
                                    <div class="text-right">
