                ...
                <div class="row"> 
                 <div class="col-sm-1"></div>
                    ...
                    <select class="form-control" onchange="selectedValue(this.value)">
                        ...
                        <option value="{{$cardDetails->FirstName}} {{$cardDetails->LastName}}">{{$cardDetails->FirstName}} {{$cardDetails->LastName}}</option>
                        @endforeach
                    </select> 
                    </div>
                    <div class="col-sm-3">
                    <select class="form-control" onchange="selectedValue(this.value)">
                        ...
                        @foreach($virtualCardsList as $k => $cardDetails)
                        <option value="{{$cardDetails->memo}}">{{$cardDetails->memo}}</option>
                        @endforeach
                    </select> 
                    </div>
                    <div class="col-sm-3">
                    <select class="form-control" onchange="selectedValue(this.value)">
                        ...
                        @foreach($virtualCardsList as $k => $cardDetails)
                        <option value="{{$cardDetails->email}}">{{$cardDetails->email}}</option>
                        @endforeach
                    </select> 
                    </div>
                        ...
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            @foreach($virtualCardsList as $k => $cardDetails)
                                ...
                                <tr>
                                    ...
                                    <td>{{$currency->symbol.number_format($cardDetails->spend_limit,2)}}</td>
                                    
                                    <td>XXXX XXXX XXXX {{$cardDetails->last_four_digit}}</td>
                                    <td>@if(empty($cardDetails->exp_month))
                                        {{'XX'}}
                                        @else
                                        {{$cardDetails->exp_month}}
                                        @endif
                                        /
                                        @if(empty($cardDetails->exp_year))
                                        {{'XXXX'}}
                                        @else
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <form action="{{route('admin.edit_virtual_card')}}" method="POST">
                                                        ...
                                                        <input type="hidden" name="last_four_digit" value="{{$cardDetails->last_four_digit}}">
                                                        <input type="hidden" name="memo" value="{{$cardDetails->memo}}">
                                                        <input type="hidden" name="spend_limit" value="{{$cardDetails->spend_limit}}">
                                                        <input type="hidden" name="spend_limit_duration" value="{{$cardDetails->spend_limit_duration}}">
