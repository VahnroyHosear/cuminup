...
<div class="container-fluid mt--6" style="background-color:white">
  ...
  <div class="content-wrapper" style="margin-top:5px;">
    <center><div class="row align-items-center " style="padding-bottom: 20px;">
      <div class="col-lg-4 col-sm-4">
        @if($created_vcards_limit->cvard_limit > 0  && Auth::user()->user_type == 1)      
            <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral" style="background: #1937e4;
    padding: 7px 15px;
    color: #ffffff;"><i class="fa fa-plus"></i> Create Virtual Card</a>
        @elseif($created_vcards_limit->cvard_limit > 0 && Auth::user()->user_type == 2 && Auth::user()->kyc_status == 1) 
         <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Create Instant Card</a>
        @else
            @if(Auth::user()->kyc_status == 1)
                <a href="{{url('user/instant_issue_designs/1')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Create Instant Card</a>
            @else                
            <a href="{{url('user/instant_issue_designs/1')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Create Instant Card</a>
      ...
      <div class="col-lg-4 col-sm-4" style="margin-top: 12px;">
    ...
    text-decoration: underline;">{{__('Remaining Cards:') }} {{$created_vcards_limit->cvard_limit}}</b>
         </div> 
    </div></center>
          ...
          <div class="modal-body p-0">
            <div class="card bg-white border-0 mb-0">
              <div class="card-header">
                <h3 class="mb-0 font-weight-bolder">Make a New Card</h3>
              ...
              <div class="card-body">
                <form method="post" action="{{route('user.create_new')}}">
                  ...
                  <div class="form-group row">
                    <label class="col-form-label col-lg-12">Card Nick Name</label>
                    <div class="col-lg-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <div class="input-group">
                          ...
                          <input type="text" name="card_limit" class="form-control" onchange="checkWalletLimit()" id="amount_id" min="{{$set->virtual_card_min_amt}}" maxlength="11" placeholder="Card extend limit e.i 100" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
                  ...
                  <div class="form-group row" id="card_type_div_id" style="display:none;">
                    ...
                    <div class="col-lg-6">
                      <?php $states =DB::table('states')->where('country_id',840)->orderby('name','ASC')->get(); ?>
                            <select class="form-control" name="postal_state" >
                                <option value="">Select State</option>
                                <?php foreach($states as $details){?>
                                <option value="{{$details->iso_code}}">{{$details->name}}</option>
                                <?php }?>
                            </select>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <?php $countries =DB::table('countries')->orderby('name','ASC')->get(); ?>
                            <select class="form-control" name="postal_country" >
                  ...
                  <div class="text">
                      <span style="font-size:12px;"><b>Note: This card will be activated with in few hours.</b></span>
                    <button type="submit" class="btn btn-neutral btn-block my-4" id="create_card_btn_id">Create Virtual Card</button>
