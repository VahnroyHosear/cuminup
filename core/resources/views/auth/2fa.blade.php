          ...
          <div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body pt-7 px-5">
              <div class="text-center text-dark mb-5">
                ...
                <small>To continue, please enter 6 digit verification code generated by <b>your authenticator app.</b></small>
              </div>
              <form role="form" action="{{route('submitfa')}}" method="post">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="{{ __('Code') }}" type="password" name="code" required maxlength="6">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <a href="{{url('user/login_with_otp')}}">Sign in another way</a>
                </div>
              </form>
            </div>
          </div>
