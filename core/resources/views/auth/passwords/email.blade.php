...
.form-error-msg{
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="{{route('login')}}" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small>Already have an account? {{__('Login')}}</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="{{route('register')}}" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small>{{__('Create an account')}}</small></a>
            </div>
          </div>
        </div>
      </div>
