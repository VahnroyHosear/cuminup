        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-dark">{{__('Verification')}}</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-3">
              <div class="text-center text-dark mb-5">
                <small>{{__('Please verify recaptcha for otp verification')}}</small><br><br>
               <small>We will send OTP on this number {{'+'}}{{$user->prefix}}{{'-XXX-XXX-XX'}}{{substr($user->phone,-2)}}</small>
              </div>
...
.form-error-msg{
          ...
          <div class="row" style="margin-top:-70px;padding:20px;">
            <div class="col-6">
              <a href="{{route('login')}}" style="text-decoration: underline;" class="text-dark"><small>{{__('Login')}}</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="{{route('register')}}" style="text-decoration: underline;" class="text-dark"><small>{{__('Create an account')}}</small></a>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div class="card border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <div class="text-center">
                                ...
                                <span style="font-size:12px">Input the code we sent to {{'+'}}{{$user->prefix}}{{'-XXX-XXX-XX'}}{{substr($user->phone,-2)}} {{'to access your account.'}}</span>
                    ...
                    <div class="modal-body p-0">
                      <div class="card border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <a href="{{url('user/logout')}}" class="btn btn-primary">Try Again!!</a>
...
//var phoneinput;
 ...
 var plusCallingCode;//str1.concat(callingCode.value);
                        plusCallingCode = '{{$customer_mobile}}';
      ...
      if(otpinput.value.length == 0)
      {
       $('#verify_otp_error_result').html('Please enter your OTP here!');
               ...
               confirmationResult.confirm(otpinput.value).then(function(response){
                  ...
                  location.href = '{{url('/')}}/2fa?u=1';   
                   //location.href = '{{url('/')}}/user/newdashboard';
