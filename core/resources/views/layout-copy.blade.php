...
<footer class="dark-bg footer">
        ...
        <div class="footer-bottom border-style top light" style=" padding:10px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center text-md-left m-5px-tb footer-reserved" style="padding-left:470px; ">
                        ...
                        <p class="m-0px font-small white-color-light right-section" style="float:left;">{{$set->site_name}}  &copy; {{date('Y')}}. {{__('All Rights Reserved.')}}</p>
                    </div>
