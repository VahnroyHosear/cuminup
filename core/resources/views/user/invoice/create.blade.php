          ...
          <div class="card-body">
            <form action="{{route('submit.invoice')}}" method="post">
              ...
              <div class="form-group row">
                <label class="col-form-label col-lg-2">{{__('Item Name')}}<span class="text-danger">*</span></label>
                <div class="col-lg-4">
                  <input type="text" name="item_name" class="form-control" placeholder="" required>
                </div>
                <label class="col-form-label col-lg-2">{{__('Invoice No')}}<span class="text-danger">*</span></label>
                <div class="col-lg-4">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    <span class="input-group-prepend">
                      <span class="input-group-text">{{$currency->symbol}}<span class="text-danger">*</span></span>
                    </span>
              ...
              <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Customer Name')}}<span class="text-danger">*</span></label>
                <div class="col-lg-4">
              ...
              <div class="form-group row">
                  <label class="col-form-label col-lg-2" for="exampleDatepicke">{{__('Due Date')}}<span class="text-danger">*</span></label>
                <div class="col-lg-4">
                  <div class='input-group date'>
                    <span class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
                    </span>
                    <input type="text" class="form-control datepicker" name="due_date" id='datetimepicker1' value="{{Carbon\Carbon::now()}}" required>
