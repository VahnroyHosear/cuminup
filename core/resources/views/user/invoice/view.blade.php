          ...
          <div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body">
              <div class="row justify-content-between align-items-center">
                <div class="col">
                  <div class="my-4">
                    ...
                    <span class="surtitle ">{{__('TO')}} {{$invoice->customer_name}}{{'('}}{{$invoice->email}}{{')'}}</span>
                  </div>
                </div>
                <div class="col-auto">
                  <div class="my-4">
              ...
              <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto">
                  <div class="my-4">
                    ...
                    <span class="surtitle ">+ {{$currency->symbol}}{{($invoice->amount*$invoice->quantity*$invoice->tax/100)}} ({{$invoice->tax}}%)</span><br>
                    <span class="surtitle ">+ {{$currency->symbol}}{{($invoice->charge)}} ({{$set->invoice_charge}}%)</span>
                  </div>
                </div>
              </div>
              <hr>
              <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto">
                  <div class="my-4">
                    <span class="surtitle ">{{$currency->symbol.number_format($total+$invoice->charge,2)}}</span>
                  </div>
                </div>
              </div>    
              @if($invoice->status==0)   
