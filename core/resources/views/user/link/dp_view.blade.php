                                ...
                                <div class="modal-body p-0">
                                    <div class="card bg-white border-0 mb-0">
                                        <div class="card-header">
                                            <h3 class="mb-0">{{$link->name}} <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                                        </div>
          ...
          <div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body">
                <div class="row justify-content-between align-items-center mb-3">
                    <div class="col-8">
                        <span class="form-text text-xl">{{$currency->symbol}} {{number_format($link->amount,2)}} Goal</span>
                    </div>
                    <div class="col-4 text-right">  
                        @if($donated<$link->amount) 
                        @if(!empty(Auth::guard('user')->user()->id))
                            <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#donation-page">{{__('Donate Now')}}</a>
                        @else
                        <a href="{{url('login')}}" class="btn btn-sm btn-success">{{__('Login to Donate')}}</a>
                        @endif
                        @endif
                    </div>
                        ...
                        <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card bg-white border-0 mb-0">
                                    <div class="card-header">
                                        <h3 class="mb-0">{{__('Contribute to this project')}}<button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                ...
                <div class="row justify-content-between align-items-center mb-3">
                    <div class="col-8">
                        <span class="form-text text-md text-dark">{{$currency->symbol}} {{number_format($donated,2)}} raised</span>
                    </div>
                </div>  
