        ...
        <div class="row" id="allcard_div_id">
            @foreach($virtualCardsList as $cardDetails)
                ...
                <div class="col-lg-4">
                  ...
                  <div class="row" style="margin-top:5px;">
                       ...
                       <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(15px, 20px, 0px);">
                            ...
                            @if($cardDetails->pin_generate == 0)
                                <a data-toggle="modal" data-target="#createpin-model{{$cardDetails->id}}" href="" class="dropdown-item"><i class="fa fa-thumb-tack "></i>Generate Pin</a>
                            @endif
                            <a data-toggle="modal" data-target="#reissue-card{{$cardDetails->id}}" href="" class="dropdown-item"><i class="fa fa-credit-card "></i>Apply for New Card</a>
             ...
             @if($cardDetails->card_state == 'OPEN') <span class="badge badge-pill badge-success">{{'Active'}}</span>
                ...
                <div class="modal fade" id="createpin-model{{$cardDetails->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                  <div class="modal-dialog modal- modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body p-0">
                        <div class="card bg-white border-0 mb-0">
                          ...
                          <div class="card-body">
                            <form method="post" action="{{route('user.createpin')}}">
                                @csrf
                ...
                <div class="modal fade" id="reissue-card{{$cardDetails->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                  <div class="modal-dialog modal- modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body p-0">
                        <div class="card bg-white border-0 mb-0">
                          ...
                          <div class="card-body">
                            <form method="post" action="{{route('user.reissue_card')}}">
                                @csrf
                              <input type="hidden" name="card_token" value="{{$cardDetails->token}}">                 
                              <div class="text-center">
