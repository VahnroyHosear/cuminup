        ...
        <div class="">
          <div class="card-body">
            <div class="text-right">
              <a data-toggle="modal" data-target="#create-plan" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__(' Create Subscription Plan')}}</a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="card-body">
                    <form action="{{route('submit.plan')}}" method="post" id="modal-details">
                      @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12">{{__('Subscription Validity')}}</label>
                            <div class="col-lg-12">
        ...
        <table class="table table-flush" id="datatable-buttons">
          <thead>
            <tr>
              ...
              <th>{{__('Status')}}</th>
              <th>{{__('Created')}}</th>
              <th class="scope">{{__('Payment URL')}}</th>  
              <th class="scope">{{__('Action')}}</th>  
            </tr>
          </thead>
          <tbody>  
              ...
              <tr>
                  ...
                  <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              ...
                              @if($val->active==1)
                               <a class='dropdown-item' href="{{url('user/unplan')}}/{{$val->id}}">{{ __('Disable')}}</a>
        ...
        @else
         <center><div class="col-md-12">
              <br>
                ...
                <p class="text-center card-text mt-4">{{__('No plan found!')}}</p>
               <h3>Let’s Create your first Plan</h3>
             <a data-toggle="modal" data-target="#create-plan" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i>  {{__('Get Started')}}</a>
