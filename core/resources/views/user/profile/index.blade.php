...
<div class="container-fluid mt--6">
   ...
   @endif
    <div class="row">
      ...
      <ul class="nav nav-pills nav-stacked" style="margin-top: 45px;">
        <li class="nav-item" style="width:14%;margin-bottom:6px;"><a class="nav-link " id="section1_ID" href="{{url('user/profile#section1')}}">Personal Info</a></li>
        <li class="nav-item" style="width:14%;margin-bottom:6px;"><a  class="nav-link" id="section2_ID" href="{{url('user/profile#section2')}}">Profile Image</a></li>
        <li class="nav-item" style="width:14%;margin-bottom:6px;"><a class="nav-link" id="section3_ID" href="{{url('user/profile#section3')}}">eKYC Document</a></li>
         <!--li class="nav-item" style="width:14%;margin-bottom:6px;"><a class="nav-link " id="section4_ID" href="{{url('user/profile#section4')}}">Social Media(Optional)</a></li-->
          <li class="nav-item" style="width:14%;margin-bottom:6px;"><a class="nav-link " id="section4_ID" href="{{url('user/profile#section4')}}">Bank Account</a></li>
        <li class="nav-item" style="width:14%;margin-bottom:6px;"><a class="nav-link " id="section5_ID" href="{{url('user/profile#section5')}}">2Factor Security</a></li>
        <li class="nav-item" style="width:13%"><a class="nav-link" id="section6_ID" href="{{url('user/profile#section6')}}">Delete Account</a></li>
    ...
    <div class="col-sm-10">
      <div id="section1">    
         <div class="card" id="edit">
          <div class="card-header header-elements-inline">
            <h3 class="mb-0">{{__('Account Setting')}}</h3>
          </div>
          <div class="card-body">
            ...
            @csrf
                ...
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">{{__('Business Name')}}(optional)</label>
                  <div class="col-lg-9">
                    <input type="text" name="business_name" class="form-control" placeholder="Your Business Name" value="{{$user->business_name}}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <div class="input-group">
                      ...
                      <input pattern=".{10,10}" required title="10 digits" name="phone" type="text" maxlength="13" class="form-control" value="{{$user->phone}}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" readonly>
                    </div>
                  </div>
                </div>     
                <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <div class="input-group">
                      ...
                      <input type="email" name="email" class="form-control" placeholder="{{__('Email Address')}}" value="{{$user->email}}" readonly>
                    </div>
                  </div>
                </div> 
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">{{__('Date of Birth')}}</label>
                  <div class="col-lg-9">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fa fa-envelope"></i></span>
                      </div>
                      <input type="email" name="email" class="form-control" placeholder="{{__('Date of Birth')}}" value="{{ Carbon\Carbon::parse($user->dob)->format('d-M-Y') }}" readonly>
                    </div>
                  </div>
                </div> 
            @if($user->user_type == 1)    
              <div class="form-group row">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="street_number" name="address1" class="form-control" placeholder="Address Line 1" value="{{$user->address1}}" @if($user->address1) {{'readonly'}} @endif maxlength="55">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">Address Line 2</label>
                  <div class="col-lg-9">
                    <input type="text" id="route" name="address2" class="form-control" placeholder="Address Line 2" value="{{$user->address2}}" @if($user->address2) {{'readonly'}} @endif   maxlength="55">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">City</label>
                  <div class="col-lg-9">
                    <input type="text" id="locality" name="city" class="form-control" placeholder="City" value="{{$user->city}}" @if($user->city) {{'readonly'}} @endif maxlength="55">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">State</label>
                  <div class="col-lg-9">
                    <input type="text" id="administrative_area_level_1" name="state" class="form-control" placeholder="State" value="{{$user->state}}" @if($user->state) {{'readonly'}} @endif  maxlength="55">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">Country</label>
                  <div class="col-lg-9">
                    <input type="text" id="country" name="country" class="form-control" placeholder="Country" value="{{$user->country}}" @if($user->country) {{'readonly'}} @endif maxlength="55">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">Zip Code</label>
                  <div class="col-lg-9">
                    <input type="text" id="postal_code" name="zip_code" class="form-control" placeholder="Zip Code" value="{{$user->zip_code}}" @if($user->zip_code) {{'readonly'}} @endif  maxlength="8">
                  </div>
                </div>
                @if($user->account_type == 'standard')
                    <div class="form-group row">
                      <label class="col-form-label col-lg-3">SSN</label>
                      <div class="col-lg-9">
                        <input type="text" id="verify_ssn" name="verify_ssn" class="form-control" placeholder="SSN" value="{{$user->verify_ssn}}" @if($user->verify_ssn) {{'readonly'}} @endif  maxlength="8">
                      </div>
                    </div>
                @endif
                @if($user->account_type == 'enterprise')
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">EIN</label>
                  <div class="col-lg-9">
                    <input type="text" id="verify_ein" name="verify_ein" class="form-control" placeholder="EIN" value="{{$user->verify_ein}}" @if($user->verify_ein) {{'readonly'}} @endif  maxlength="8">
                  </div>
                </div>
                @endif
                @endif
                @if($user->user_type == 2)
                <div class="form-group row">
                  <label class="col-form-label col-lg-3"><b style="color:#5151fa">{{__('Your Product Pickup Address')}} </b>(i.e Shop or Warehouse or Office)</label>
                  <div class="col-lg-9">
                ...
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">{{__('Shipping Margin (upto 5%)')}}</label>
                  <div class="col-lg-9">
                    <input type="number" min="0" max="5" class="form-control" name="shipping_margin" placeholder="Shipping Margin" value="{{$user->shipping_margin}}">
                  </div>
                ...
                @endif
                <div class="form-group row">
                <label class="col-form-label-castro col-lg-3">{{__('Password')}}</label>
                <div class="col-lg-9">
               ...
               @if($user->user_type == 2)
                ...
                <div id="add_phy_address">
                    <!--<div class="form-group row">-->
                    <!--  <label class="col-form-label col-lg-3">{{__('Physical Address')}}</label>-->
                    <!--  <div class="col-lg-9">-->
                    <!--    <input type="text" class="form-control" id="autocomplete" onFocus="geolocate()" placeholder="Enter your address">-->
                    <!--  </div>-->
                    <!--</div>-->
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success btn-sm">{{__('NEXT')}}</button>
                </div>
            </form>
          </div>
        </div>
      ...
      <div id="section2">
          ...
          <div class="card-body text-center">
            <h3 class="card-title mb-3">{{__('Change Profile Image')}}</h3>
            
            <!--p class="card-text text-sm">{{__('Please upload your photo.')}}</p-->
            ...
            @csrf
                <div class="form-group">
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="customFileLang" style="border: 1px solid blue;">{{__('Choose Media')}}</label-->
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-success btn-sm" id="avatar_submit_btn_id">{{__('NEXT')}}</button>
              </div>
            </form>
          </div>
        </div>
     ...
     <div id="section3">
           <div class="card">
          <div class="card-body text-center">
            <h3 class="card-title mb-3">{{__('KYC')}}</h3>
            <!--p class="card-text text-sm" style="    color: #4a4af1;">{{__('Please update your US SSN No. company EIN with National ID get full acess of all services.')}}</p-->
                ...
                @csrf
                    <div class="form-group">
                      <div class="custom-file">
                        ...
                        <div class="col-10"><input type="text" class="form-control" name="verify_ssn" placeholder="Your SSN Number" value="{{$user->verify_ssn}}"></div>
                        </div-->
                        <!--div class="row">
                           <div class="col-2">
                        <label style="text-align:left">EIN</label></div>
                       <div class="col-10">
                        <input type="text" class="form-control mt-1" name="verify_ein" placeholder="Company EIN Number"  value="{{$user->verify_ein}}">
                        </div>
                        </div-->
                        <br>
                        <div class="row">
                       ...
                       <!--input type="file" class="custom-file-input" id="customFileLang2" name="photo_id" required>
                        <label class="custom-file-label sdsd1" for="customFileLang2" style="top: 0px;">{{__('Upload National ID')}}</label-->
                ...
                <div class="card-body text-center">
                    <span class="badge badge-pill badge-primary">
                        <!--a href="{{route('user.upgrade')}}"><span class="badge badge-pill badge-primary">Upgrade to Business</span></a-->
                         <a href="{{route('user.doc-verification')}}"><span class="badge badge-pill badge-primary" style="background-color: #1d0d44;color:white">Upgrade to Business</span></a>
      ...
      <div id="section4" class="onscroll_chnage">         
          <div class="card" id="edit">
          <div class="card-header header-elements-inline">
            <h3 class="mb-0">{{__('Bank Account')}}</h3>
          </div>
          <div class="card-body">
                ...
                @if(!empty($bank->id))
                      ...
                      @csrf
                        <div class="form-group row">
                          ...
                          <div class="col-lg-10">
                              @if(!empty($bank->id))
                              <input type="hidden" name="id" class="form-control" value="{{$bank->id}}">
                              @endif
                              <input type="hidden" name="added_by" class="form-control" value="profile">
                            <input type="text" name="name" class="form-control" required maxlength="55" @if(!empty($bank->name)) value="{{$bank->name}}" @endif>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-form-label col-lg-2">{{__('Account Name')}}</label>
                          <div class="col-lg-10">
                            <input type="text" name="acct_name" class="form-control" required maxlength="55" @if(!empty($bank->acct_name)) value="{{$bank->acct_name}}" @endif>
                          </div>
                        </div>                                                                      
                        <div class="form-group row">
                          <label class="col-form-label col-lg-2">{{__('Account No')}}</label>
                          <div class="col-lg-10">
                            <input type="text" name="acct_no" class="form-control" required maxlength="55" @if(!empty($bank->acct_no)) value="{{$bank->acct_no}}" @endif onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                          </div>
                        </div>                        
                        <div class="form-group row">
                          <label class="col-form-label col-lg-2">{{__('Routing No')}}</label>
                          <div class="col-lg-10">
                            <input type="text" name="swift" class="form-control" required maxlength="55" @if(!empty($bank->swift)) value="{{$bank->swift}}" @endif>
                          </div>
                        </div>
                        <div class="text-center">
        ...
        <div class="card bg-white" id="2fa">
          <div class="card-body">
            ...
            <div class="align-item-sm-center flex-sm-nowrap text-left">
                ...
                <span class="form-text text-sm text-default">
                {{__('2. Use the authenticator app to scan the barcode below.')}}               </span>
                <span class="form-text text-sm text-default">
                {{__('3. Enter the code generated by the authenticator app.')}} <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en_IN&gl=US" target="_blank">Get it on Playstore</a>
                </span>
              ...
              <div class="card" id="kyc">
                {{--<div class="card-body text-center">
                  ...
                  <span class="badge badge-pill badge-primary mb-3">
                    ...
                    {{__('Rejected')}} <a href="{{url('user/upgrade')}}" class="mr-3 upgrade-premium">{{__('Reupload Now')}}</a>
                    @else
                    {{__('Verified')}}
                    @endif
                  </span>
            ...
            <div class="modal-content">
              <div class="modal-body p-0">
                <div class="card bg-white border-0 mb-0">
                  <div class="card-header">
                    <h3 class="mb-0">{{__('Are you sure do you want to delete it?')}} <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                    <form action="{{route('delaccount')}}" method="post">
                      ...
                      <div class="form-group row">
                        <div class="col-lg-12">
                          <textarea type="text" name="reason" class="form-control" rows="5" placeholder="{{__('Sorry to see you leave, Please tell us why you are leaving us?')}}" required></textarea>
                        </div>
                      </div>             
                      <div class="text-right">
                          <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">{{__('Close')}}</button>
                        <button type="submit" class="btn btn-success btn-sm">{{__('Yes delete my account')}}</button>
                      </div>
                    </form>
          ...
          <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
              <div class="modal-body p-0">
                <div class="card bg-white border-0 mb-0">
                  <div class="card-header header-elements-inline">
                    <h3 class="mb-0">{{__('Change Password')}} <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                    <form action="{{route('change.password')}}" method="post">
                      @csrf
                      <div class="form-group row">
                        <label class="col-form-label col-lg-5">{{__('Current Password')}}</label>
                        <div class="col-lg-7">
                      ...
                      <div class="form-group row">
                        <label class="col-form-label col-lg-5">{{__('New Password')}}</label>
                        <div class="col-lg-7">
                      ...
                      <div class="form-group row">
                        <label class="col-form-label col-lg-5">{{__('Confirm Password')}}</label>
                        <div class="col-lg-7">
                      ...
                      <div class="text-right">
                        <button type="submit" class="btn btn-success btn-sm" id="continue_click">{{__('Change Password')}}</button>
                      </div>
                    </form>
                  </div>
                </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content text-center mt-5 pt-5 pb-4">
      ...
      <a href="{{route('user.upgrade')}}"><p>Yes..</p></a>
    </div>
  </div>
</div-->
