              ...
              <div class="modal-body p-0">
                <div class="card bg-white border-0 mb-0">
                  <div class="card-header">
                    <h3 class="mb-0">{{__('Withdraw Request')}} <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                  </div>
                  <div class="card-body">
      ...
      <div class="col-md-8">
        ...
        @else
         <center> <div class="col-md-12">
            <!--br>
              <p class="text-center text-muted card-text mt-8">{{__('No Withdraw History Found!')}}</p>
               <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('Start Withdraw Money')}}</a>
              <p class="text-center text-muted card-text mt-8"></p>
              <br-->
              <br>
              <p class="text-center text-muted card-text mt-8">{{__('No Withdraw History Found!')}}</p>
              <a data-toggle="modal" data-target="#modal-formx" href="#" class="btn btn-neutral"><i class="fa fa-plus"></i> {{__('Request to withdraw money in your account')}}</a>
              <p class="text-center text-muted card-text mt-8"></p>
              <br>
