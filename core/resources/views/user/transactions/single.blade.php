  ...
  <div class="content-wrapper">
    <div class="card">
      ...
      <center>
           <div class="col-lg-12">
              <br>
                <p class="text-center card-text mt-5">{{__('No single charge Found!')}}</p>
               <h3>{{__('Let’s Create your first single charge')}}</h3>
             <a href="{{url('user/sc-links')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('Get Started')}}</a>
