                         ...
                         <div class="form-group row">
                            <div class="col-xs-12 col-md-12 form-group required">
                              <div class="input-group">
                                ...
                                <input type="text" step="any" class="form-control" name="amount" id="cardamount" onchange="cardcharge()" maxlength="10" placeholder="0.00" min="{{$stripe->minamo}}" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"> 
      ...
      <div class="col-md-12">
        ...
        <table class="table table-flush" id="datatable-buttons">
            ...
            @foreach($transfer as $k=>$val)
              <tr>
                ...
                <td>{{$currency->symbol.number_format($val->amount,2)}}</td>
                 ...
                 <td>@if(!empty($val->receiver['email']))
          ...
          <center><div class="col-md-12">
              <br>
              <p class="text-center text-muted card-text mt-8">{{__('No Send History Found!')}}</p>
              <a data-toggle="modal" data-target="#modal-formx" href="#" class="btn btn-neutral"><i class="fa fa-plus"></i> {{__('Start Sending Money')}}</a>
...
function setSessionFunction() {
  ...
  @endphp
    ...
    $(window).on('load', function() {
         @if(Session::has('from_dashboard'))
          // 
           @php Session::forget('from_dashboard'); @endphp
        @endif  
    });
</script>
