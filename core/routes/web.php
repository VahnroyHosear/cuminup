...
Route::post('vcard-single-pay_bypaypal', 'UserController@vCardSendsingle')->name('paypal.vcard.single');
...
//FOR VIRTUAL CARD PRIVACY WEBHOOK URL
...
// Sandeep--Contact_us page start
Route::get('/contact-us', 'FrontendController@contactus')->name('contact');
Route::get('/integration', 'FrontendController@integration')->name('integration');

// Sandeep--Contact_us page End
...
Route::get('/cookiespolicy', 'FrontendController@cookiespolicy')->name('cookiespolicy');
Route::get('/developers', 'FrontendController@developers')->name('developers');
Route::get('/physical-card', 'FrontendController@plasticcard');
Route::get('/prepaid-card', 'FrontendController@prepaidcard');
Route::get('/virtual-card', 'FrontendController@virtualcard');
Route::get('/ewallet-solution', 'FrontendController@ewalletsolution');
Route::get('/e-invoicing-solution', 'FrontendController@einvoicingsolution');
Route::get('/payment-solution', 'FrontendController@paymentsolution');
Route::get('/online-selling-software', 'FrontendController@onlinesellingsoftware');
Route::get('/ewallet-topup-software', 'FrontendController@ewallettopupsoftware');
Route::get('/subscription-management-software-system', 'FrontendController@subscriptionsoftwaresystem');
Route::get('/e-signfront', 'FrontendController@esignfront')->name('e-signfront');
Route::get('/getach', 'FrontendController@ach')->name('getach');
Route::get('/cards', 'FrontendController@cards')->name('cards');
...
// Route::get('/virtual-card-number', 'FrontendController@webplugin');
// sandeep--code start
Route::get('/virtual-card-number', 'FrontendController@virtualcardnumber');
// Sandeep--code End
//Route::get('/shopping-cart-plugin', 'FrontendController@webplugin');
Route::get('/secure-card', 'FrontendController@paymenturl');
Route::get('/enterprise-payment-solution', 'FrontendController@ecomsolution')->name('enterprise-payment-solution');
...
Route::group(['prefix' => 'user', ], function () {
     Route::get('doc-verification', 'UserController@DocVerfication')->name('user.doc-verification');
    Route::get('login_with_otp', 'UserController@loginOtpByFirebase')->name('user.login_with_otp');   
    ...
    Route::post('postEmailVerify', 'UserController@postEmailVerify')->name('user.email-verify'); 
     Route::post('postMobileVerify', 'UserController@postMobileVerify')->name('user.mobile-verify'); 
      Route::post('postMobileUpdate', 'UserController@updateMobile')->name('user.mobile-update'); 
        Route::group(['middleware'=>'auth:user'], function() {
            Route::middleware(['CheckStatus', 'Tfa'])->group(function () {
                Route::middleware(['Banks'])->group(function () {
                    Route::post('card_before', 'UserController@card_before')->name('card_before');
                     Route::post('recollect_cvc', 'UserController@recollectCVC')->name('recollect_cvc');
                    Route::post('card', 'UserController@card')->name('card');
                    
                     Route::post('paypal', 'UserController@PayPal')->name('paypal');
                     Route::post('paypal_success', 'DepositController@PaypalSuccess')->name('paypal_success');
                    ...
                    Route::get('all-transactions', 'UserController@allTransactionlog')->name('user.alltransactions');
                    ...
                    Route::get('category_add', 'RestController@CategoryForm')->name('user.category_add');
                    Route::post('category_insert', 'RestController@CategoryInsert')->name('user.category_insert');
                    ...
                    Route::post('signup', 'NewController@RegisterFormDetails')->name('user.signup');
                     ...
                     Route::post('business_docs', 'UserController@businessDocs');
                     Route::get('send_for_verification', 'UserController@sendForVerification');
                      Route::get('add_another/{add_type}', 'UserController@AddAnother');
                     Route::post('business_project_info', 'UserController@businessProjectInfo_old');
                     Route::post('business_representative_beneficiary', 'UserController@businessRepresentativeBeneficiary');
                     Route::post('business_representative_shareholder', 'UserController@businessRepresentativeShareholder');
                      Route::post('business_representative_director', 'UserController@businessRepresentativeDirector');
                    Route::post('additional_business_docs', 'UserController@additionalBusinessDocs');
                    Route::post('kyc', 'UserController@kyc');
                    Route::post('account', 'UserController@account');
                     Route::post('business_profile', 'UserController@businessProfile');
                    ...
                    //Products
                        ...
                        Route::get('product-result', 'UserController@productResult')->name('product.result');
                        Route::get('order-result', 'UserController@orderResult')->name('order.result');
                        Route::post('order-status', 'UserController@orderStatus')->name('order.status');
                    //End
                     Route::get('doc-verification', 'UserController@DocVerfication')->name('user.doc-verification');
                    //Merchant
                    ...
                    //VIRTUAL CARD
                        ...
                        Route::get('physicalcard', 'VirtualCardController@physicalcard')->name('user.physicalcard');
                        ...
                        Route::post('select_country_by_state','VirtualCardController@selectCountry_byState')->name('user.select_country_by_state');
                        Route::post('createpin', 'VirtualCardController@createpin')->name('user.createpin');
                        Route::post('reissue_card', 'VirtualCardController@reissueCard')->name('user.reissue_card');
                    ...
                    //Bank
                        ...
                        Route::post('verify_bank', 'UserController@Verifybank')->name('bank.verify');
                        Route::put('delete_bank', 'UserController@Deletebank')->name('bank.lithicdelete');
                        Route::get('restore_bank/{id}', 'UserController@Restorebank')->name('bank.restore');
                    //End

                    //Send money
                        Route::get('sendmoney', 'UserController@sendmoney')->name('user.sendmoney');
                        ...
                        Route::get('reject_money/{id}', 'UserController@Rejectpay')->name('reject.pay');
...
Route::get('user-doc/reupload/{token}', 'User\ResetPasswordController@showReuploadForm')->name('user.doc.reupload');
Route::post('user-reupload', 'User\ResetPasswordController@submitReuploadData')->name('user.reupload');
Route::get('user-reupload/thankyou', 'User\ResetPasswordController@reuploadThakyou')->name('user.reupload.thankyou');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::get('/multi_user_update', 'AdminController@multiUserUpdate')->name('admin.multi_user_update');
    //VIRTUAL CARDS
    ...
    Route::get('/physical_virtual_card', 'AdminController@virtualPhysical')->name('admin.physical_virtual_card');
    ...
    Route::put('edit_virtual_card','AdminController@editVirtualCard')->name('admin.edit_virtual_card');
    ...
    //SEO Module
    Route::get('seo', 'AdminController@seoindex')->name('admin.seo');
    Route::post('seo/create', 'AdminController@seocreate')->name('admin.seo.create');
    Route::post('seo/update/{seoId}', 'AdminController@seoUpdate')->name('admin.seo.update');
    Route::get('seo/delete/{seoId}', 'AdminController@Destroyseo')->name('admin.seo.delete');
    ...
    Route::get('e-sign', 'WebController@esign')->name('e-sign'); 
    Route::post('e-sign/update', 'WebController@UpdateEsign')->name('e-sign.update');
    ...
    Route::get('pcountry/{id}', 'WebController@pcountry')->name('change.country'); 
    Route::get('uncountry/{id}', 'WebController@uncountry')->name('change.decountry'); 
    ...
    Route::get('enterprise_pending', 'AdminController@enterprisePending')->name('admin.enterprise_pending');
    ...
    Route::get('promo', 'AdminController@Promo')->name('admin.promo');
     Route::get('send_push_notification', 'AdminController@sendPushNotification')->name('admin.send_push_notification');
    ...
    Route::get('verification-kyc/{id}', 'AdminController@Verificationkyc')->name('admin.verfication.kyc');
     Route::post('verification-kyc', 'AdminController@VerificationkycStaus')->name('admin.verification.kyc_status');
    Route::post('reject-kyc/{id}', 'AdminController@Rejectkyc')->name('admin.reject.kyc');
    
    // Bhawesh Lithics
    Route::post('update-limits/{id}', 'AdminController@Updatelimit')->name('admin.update.limit');
    Route::get('lithics-activate/{id}', 'AdminController@Activatelithics')->name('admin.activate.lithics');
    Route::get('lithics-deactivate/{id}', 'AdminController@Deactivatelithics')->name('admin.deactivate.lithics');
