          ...
          <div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body pt-7 px-5">
              <div class="row justify-content-between align-items-center mb-3">
                  <label class="col-form-label col-lg-3.5"><?php echo e(__('Payable Amount')); ?></label>
                <?php if($link->amount!=null): ?>
                    <span class="form-text text-xl"><center><?php echo e($currency->symbol); ?> <?php echo e(number_format($link->amount,2)); ?></center></span>
                <?php endif; ?>
              </div>
              <form role="form" action="<?php echo e(route('submit.plancharge')); ?>" method="post" id="modal-details">
                ...
                <div class="row justify-content-between align-items-center mb-3">
                    <label class="col-form-label col-lg-3.5"><?php echo e(__('Auto renewal')); ?></label>
                ...
                <?php endif; ?>
                <div class="row justify-content-between align-items-center mb-3">
                  <label class="col-form-label col-lg-3.5"><?php echo e(__('Validity')); ?></label>
                <div class="text-right">  
                    ...
                    <div class="modal-content">
                      <div class="modal-body p-0">
                        <div class="accordion" id="accordionExample">
                             <h3 class="mb-0" style="padding: 15px;"><?php echo e(__('Pay with Available Balance')); ?> <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                              ...
                              <div class="card-body text-center">
                                <?php if(Auth::guard('user')->check()): ?>
                                  <form method="post" role="form" action="<?php echo e(route('submit.plancharge')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <h4 class="mb-0"><?php echo e(__('Available Balance')); ?></h4>
                ...
                <div class="text-center">
                    <?php if(Auth::guard('user')->check()): ?>
                                  <button type="button" data-toggle="modal" data-target="#fund" class="btn btn-success my-4"><?php echo e(__('Pay Now')); ?></button>
                                <?php else: ?>
                                <?php
                                Session::put('oldLink', url()->current());
                                ?>
                                   <a href="<?php echo e(route('login')); ?>" class="btn btn-neutral btn-sm"><?php echo e(__('Login and Pay')); ?></a>
                                <?php endif; ?>
...
<?php echo $__env->make('paymentlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/plans/sub_view.blade.php ENDPATH**/ ?>