    ...
    <div class="col-lg-4">
        <div class="card bg-white shadow">
          ...
          <?php if(Auth::user()->user_type == 1): ?>
           <a href="<?php echo e(route('user.virtualcard')); ?>" class="btn btn-success btn-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Manage Virtual Cards')); ?></a>
                ...
                <div class="alert alert-error alert-dismissible" style="height:50px;background-color: #dd4b39;color: #ffffff;">
    				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    				  <strong><i class="icon fa fa-warning"></i>Alert!</strong>
    				   Your Enterprise account is not started yet. Please upload the document to start.
    				<span class="pull-right">
    					<a href="<?php echo e(route('user.doc-verification')); ?>" class="btn bg-navy" style="display:unset !important;background-color: #001f3f ;color: #ffffff;"><i class="fa fa-rocket"></i>  Upgrade Now</a>
    				</span>
                </div>
                <!--<?php endif; ?>-->
          </div>
      ...
      <div class="col-lg-4">
        <div class="card bg-white shadow">
          <div class="card-body">
            ...
            <?php if(Auth::user()->user_type == 1): ?>
            <a class="btn btn-disabled btn-sm" type="button" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Create Invoice')); ?></a>
            <?php else: ?>
            <a href="<?php echo e(url('user/invoice')); ?>" class="btn btn-success btn-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Create Invoice')); ?></a>
            <?php endif; ?>
        ...
        <div class="card bg-white shadow">
          <div class="card-body">
            ...
            <p class="card-text text-sm"><?php echo e(__('Sending payment link for single charge is now possible. Single charge is a one time payment for any needed service or product.')); ?></p>
             <?php if(Auth::user()->user_type == 1): ?>
            <a class="btn btn-disabled btn-sm" type="button" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Payment Links')); ?></a>
            <?php else: ?>
       ...
       <div class="col-lg-4">
        <div class="card bg-white shadow">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-12">
                <h3 class="card-title mb-3"><?php echo e(__('Sell Online')); ?></h3>
              </div>
            </div>
         ...
         <?php if(Auth::user()->user_type == 1): ?>
         <a class="btn btn-disabled btn-sm" type="button" data-toggle="modal" data-target=".bd-example-modal-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Sell Product')); ?></a>
         <?php else: ?>
      ...
      <div class="col-lg-4">        
        <div class="card bg-white shadow">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-12">
                <h3 class="card-title mb-3"><?php echo e(__('Donation')); ?></h3>
              </div>
            </div>
            <p class="card-text text-sm"><?php echo e(__('You can now create a donation to get funds for any project')); ?></p>
            <?php if(Auth::user()->user_type == 1): ?>
        ...
        <?php if($set->merchant==1): ?>
          <div class="card bg-white shadow">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-12">
                  <h3 class="card-title mb-3"><?php echo e(__('Payment URLs')); ?></h3>
                </div>
              </div>
              <p class="card-text text-sm">Receiving money on your website is now easy with simple integeration at a fee of <?php echo e($set->single_charge); ?>% per transaction</p>
              <?php if(Auth::user()->user_type == 1): ?>
              ...
              <?php else: ?>
                <a href="<?php echo e(url('user/sc-links')); ?>" class="btn btn-success btn-sm"><i class="fa fa-arrow-right"></i> <?php echo e(__('Payment URLs')); ?></a>
              <?php endif; ?>
            </div>
          </div>
        <?php endif; ?>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/dashboard/index.blade.php ENDPATH**/ ?>