...
<html class="no-js" lang="en">
    <head>
        ...
        <meta name="description" <?php if(empty($product_desc)): ?> content="<?php echo e($set->site_desc); ?>" <?php else: ?> content="<?php echo e($product_desc); ?>" <?php endif; ?> />
        <link rel="shortcut icon" <?php if(empty($logo_product_img)): ?>href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->image_link2); ?>" <?php else: ?> href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo_product_img); ?>" <?php endif; ?>  />
        <link rel="apple-touch-icon" <?php if(empty($logo_product_img)): ?>href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->image_link2); ?>" <?php else: ?> href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo_product_img); ?>" <?php endif; ?>/>
        <link rel="apple-touch-icon" sizes="72x72" <?php if(empty($logo_product_img)): ?>href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->image_link2); ?>" <?php else: ?> href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo_product_img); ?>" <?php endif; ?> />
        <link rel="apple-touch-icon" sizes="114x114" <?php if(empty($logo_product_img)): ?>href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->image_link2); ?>" <?php else: ?> href="<?php echo e(url('/')); ?>/asset/<?php echo e($logo_product_img); ?>" <?php endif; ?> />
...
</script><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/paymentlayout.blade.php ENDPATH**/ ?>