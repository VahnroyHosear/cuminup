          ...
          <tbody>  
            <?php $__currentLoopData = $virtualCardsOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$OrderDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <tr>
                  ...
                  <td><?php echo e($OrderDetails->plan_quantity); ?> <?php if(!empty($OrderDetails->plan_quantity)): ?> <?php echo e(__('Cards')); ?> <?php endif; ?></td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/user/vcard_orders.blade.php ENDPATH**/ ?>