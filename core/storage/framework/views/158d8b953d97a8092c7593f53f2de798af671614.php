        ...
        <div class="table-responsive py-4">
            <table class="table table-flush" id="datatable-buttons">
                ...
                <?php $__currentLoopData = $ticket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e(++$k); ?>.</td>
                        <td><a href="<?php echo e(url('admin/manage-user')); ?>/<?php echo e($val->user->id); ?>"><?php echo e($val->user['first_name']); ?> <?php echo e($val->user['last_name']); ?></a></td>
                        ...
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a href="<?php echo e(route('ticket.manage', ['id' => $val->id])); ?>" class="dropdown-item"><?php echo e(__('Reply ticket')); ?></a>
                                    <?php if($val->status==0): ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/user/ticket.blade.php ENDPATH**/ ?>