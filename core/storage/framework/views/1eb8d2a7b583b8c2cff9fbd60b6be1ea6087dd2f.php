			...
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td valign="middle" width="80%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;">- <?php echo $discount; ?> (<?php echo $r_d; ?>%)</span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="20%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="80%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;">+ <?php echo $tax; ?> (<?php echo $r_t; ?>%)</span>
					</td>
				</tr>
			</table>
		</tr>
				...
				<table>
					...
					<tr>
						...
						<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
							<tr>
							<td style="text-align: center; padding-right: 10px; font-size: 12px;">
								<p><a href="<?php echo e(route('view.invoice', ['id' => $payment_link])); ?>">Click here </a> to make payment</p>
							</td>
							</tr>
						</table>
						</td>
...
</html><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/emails/invoice/sender/invoice.blade.php ENDPATH**/ ?>