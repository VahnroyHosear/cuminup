...
<?php $__currentLoopData = $virtualCardsDesign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $productDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo e(__('List of All Card Design')); ?></h3>
                        
                    </div>
 <div class="row"> 
 <?php $__currentLoopData = $virtualCardsDesign; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $designDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-4">
        <div class="card">
           
          <div class="card-body"> 
          <h3><?php echo e($designDetails->design_name); ?></h3>
            <div class="card">
            <!-- Card body -->
            ...
            <div class="card-body<?php echo e($designDetails->id); ?>">
              ...
              <div class="my-4">
                ...
                <div class="text-primary" data-toggle="modal" data-target="#editDesign<?php echo e($designDetails->id); ?>" style="cursor: pointer;">
    ...
    font-size: 13px;color: #ffffff !important;">$20.00 / <span class="text-gray" style="color: #ffffff !important;">$1000</span></span>
      ...
      <div class="modal fade" id="editDesign<?php echo e($designDetails->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    <div class="card-header">
                                                      ...
                                                      <form action="<?php echo e(route('admin.edit_virtual_card_design')); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                       <input type="hidden" name="design_id" value="<?php echo e($designDetails->id); ?>">
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                                <?php echo e(__('Name')); ?></label>
                                                            </div>
                                                             <div class="col-sm-9">
                                                                 <input class="form-control" type="text" name="design_name" placeholder="Enter Card Type Name" value="<?php echo e($designDetails->design_name); ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <select class="form-control" name="status">
                                                                     <option value="1" <?php if($designDetails->status == 1): ?><?php echo e('selected'); ?> <?php endif; ?>>Active</option>
                                                                     <option value="0" <?php if($designDetails->status == 0): ?><?php echo e('selected'); ?> <?php endif; ?>>Inactive</option>
                                                                </select>     
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <textarea class="form-control" type="text" name="description" placeholder="Enter Description"  required><?php echo e($designDetails->description); ?></textarea>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal fade" id="delete<?php echo e($designDetails->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                                        ...
                                                        <a  href="<?php echo e(route('admin.delete_virtual_card_design', ['id' => $designDetails->id])); ?>" class="btn btn-danger btn-sm"><?php echo e(__('Proceed')); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    <div class="card-header">
                                                      ...
                                                      <form action="<?php echo e(route('admin.add_virtual_card_design')); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/user/vcard_design.blade.php ENDPATH**/ ?>