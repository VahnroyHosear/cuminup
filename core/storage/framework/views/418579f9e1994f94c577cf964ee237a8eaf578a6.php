    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0"><?php echo e(__('Update Account Information')); ?>

                          <a class="badge badge-warning" style="float:right;color:black;"href="<?php echo e(url('admin/users')); ?>" ><i class="fa fa-angle-double-left"></i> Back</a>
                        </h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                            ...
                            <div>
                                <ul class="list list-unstyled mb-0">
                                    ...
                                    <li><span class="text-sm">
                                        ...
                                        <?php echo e(__('Last Login:')); ?> <?php echo e(date("Y/m/d h:i:A", strtotime($client->last_login))); ?>

                                        <?php else: ?>
                                        <?php echo e(__('Last Login:')); ?> <?php echo e(date("Y/m/d h:i:A", strtotime($client->created_at))); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo e(__('KYC-Entreprise Verification')); ?></h3>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center">
                                        ...
                                        <?php elseif($client->kyc_status==1): ?>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                            <a class="text-dark" href="<?php echo e(url('/')); ?>/admin/verification-kyc/<?php echo e($client->id); ?>" title="View User Details">
                                            ...
                                            <?php if($client->kyc_status!=1): ?>
                                                ...
                                                <a class='dropdown-item' href ="<?php echo e(url('/')); ?>/admin/verification-kyc/<?php echo e($client->id); ?>"><i class="icon-eye mr-2"></i><?php echo e(__('Approve')); ?></a>
                                            ...
                                            <?php if($client->kyc_status==1): ?>
                                                <a class='dropdown-item' href ="<?php echo e(url('/')); ?>/admin/verification-kyc/<?php echo e($client->id); ?>"><i class="icon-eye mr-2"></i><?php echo e(__('View Details')); ?></a>
                                                <a class='dropdown-item' data-toggle="modal" data-target="#rejectmessage"><i class="icon-eye-blocked2 mr-2"></i><?php echo e(__('Reject')); ?></a>
                                            <?php endif; ?>
                                            </div>
                                        </div>
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($client->photo_id)): ?>
                                        <a href="<?php echo e(url('/')); ?>/asset/profile/<?php echo e($client->photo_id); ?>" target="_blank"><?php echo e(__('View')); ?></a>
                                        <?php else: ?>
                                        <?php echo e('Not uploaded'); ?>
                ...
                <?php if(!empty($get_token)): ?>
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-5">
                                <h3 class="card-title"><?php echo e(__('Set Limits')); ?></h3>
                            </div>
                            <div class="col-md-7">
                                <?php if($client->lithic_status == 'PAUSED'): ?>
                                    <a href="<?php echo e(url('admin/lithics-activate/'.$client->id)); ?>" class="btn btn-sm btn-neutral"><?php echo e(__('Activate Account')); ?></a>
                                <?php elseif($client->lithic_status == 'ACTIVE'): ?>
                                    <a href="<?php echo e(url('admin/lithics-deactivate/'.$client->id)); ?>" class="btn btn-sm btn-warning"><?php echo e(__('Deactivate Account')); ?></a>
                                <?php else: ?>
                                    <a class="btn btn-sm btn-warning"><?php echo e(__('No Account')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                                        
                        <form action="<?php echo e(url('admin/update-limits/'.$client->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-6"><?php echo e(__('Status')); ?></label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" name="lithic_status" value="<?php echo e($get_token->data[0]->state); ?>" class="form-control" disabled>
                                    </div>
                                </div>
                            </div> 
                            
                            <div class="form-group row">
                                <label class="col-form-label col-lg-6"><?php echo e(__('Daily Spend Limit')); ?></label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text"><?php echo e($currency->symbol); ?></span>
                                        </span>
                                        <input type="text" name="daily_limit" value="<?php echo e($get_token->data[0]->spend_limit->daily); ?>" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            
                            <div class="form-group row">
                                <label class="col-form-label col-lg-6"><?php echo e(__('Monthly Spend Limit')); ?></label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text"><?php echo e($currency->symbol); ?></span>
                                        </span>
                                        <input type="text" name="monthly_limit" value="<?php echo e($get_token->data[0]->spend_limit->monthly); ?>" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            
                            <div class="form-group row">
                                <label class="col-form-label col-lg-6"><?php echo e(__('Lifetime Spend Limit')); ?></label>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text"><?php echo e($currency->symbol); ?></span>
                                        </span>
                                        <input type="text" name="lifetime_limit" value="<?php echo e($get_token->data[0]->spend_limit->lifetime); ?>" class="form-control">
                                    </div>
                                </div>
                            </div> 
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>