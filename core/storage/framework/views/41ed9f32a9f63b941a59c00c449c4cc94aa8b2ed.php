  ...
  <div class="content-wrapper">
    <div class="card">
      <div class="card-header header-elements-inline">
        <h3 class="mb-0"><?php echo e(__('Invoice Charge')); ?></h3>
      </div>
        ...
        <table class="table table-flush" id="datatable-buttons">
          ...
          <tbody>  
            <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e(++$k); ?>.</td>
                <td><?php echo e($val->inplan['item']); ?></td>
      ...
      <center>
           <div class="col-lg-12">
              <br>
                <p class="text-center card-text mt-5"><?php echo e(__('No invoice Found!')); ?></p>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/transactions/invoice.blade.php ENDPATH**/ ?>