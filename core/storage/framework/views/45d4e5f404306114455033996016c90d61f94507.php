                ...
                <div class="row"> 
                 <div class="col-sm-1"></div>
                    ...
                    <select class="form-control" onchange="selectedValue(this.value)">
                        ...
                        <option value="<?php echo e($cardDetails->FirstName); ?> <?php echo e($cardDetails->LastName); ?>"><?php echo e($cardDetails->FirstName); ?> <?php echo e($cardDetails->LastName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select> 
                    </div>
                    <div class="col-sm-3">
                    <select class="form-control" onchange="selectedValue(this.value)">
                        <option value="">Select by Card Name</option>
                        <?php $__currentLoopData = $virtualCardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $cardDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cardDetails->memo); ?>"><?php echo e($cardDetails->memo); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select> 
                    </div>
                    <div class="col-sm-3">
                    <select class="form-control" onchange="selectedValue(this.value)">
                        ...
                        <?php $__currentLoopData = $virtualCardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $cardDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cardDetails->email); ?>"><?php echo e($cardDetails->email); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select> 
                    </div>
                            ...
                            <?php $__currentLoopData = $virtualCardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $cardDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(url('admin/manage-user')); ?>/<?php echo e($cardDetails->user_id); ?>"><?php echo e($cardDetails->FirstName); ?> <?php echo e($cardDetails->LastName); ?></a></td>
                                     <td><?php echo e($cardDetails->email); ?></td>
                                    <td><?php echo e($cardDetails->memo); ?></td>
                                    <td><?php echo e($currency->symbol.number_format($cardDetails->spend_limit,2)); ?></td>
                                    
                                    <td>XXXX XXXX XXXX <?php echo e($cardDetails->last_four_digit); ?></td>
                                    <td><?php if(empty($cardDetails->exp_month)): ?>
                                        <?php echo e('XX'); ?>

                                        <?php else: ?>
                                        <?php echo e($cardDetails->exp_month); ?>

                                        <?php endif; ?>
                                        /
                                        <?php if(empty($cardDetails->exp_year)): ?>
                                        <?php echo e('XXXX'); ?>

                                        <?php else: ?>
                                        <?php echo e($cardDetails->exp_year); ?>
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <form action="<?php echo e(route('admin.edit_virtual_card')); ?>" method="POST">
                                                        ...
                                                        <input type="hidden" name="last_four_digit" value="<?php echo e($cardDetails->last_four_digit); ?>">
                                                        <input type="hidden" name="memo" value="<?php echo e($cardDetails->memo); ?>">
                                                        <input type="hidden" name="spend_limit" value="<?php echo e($cardDetails->spend_limit); ?>">
                                                        <input type="hidden" name="spend_limit_duration" value="<?php echo e($cardDetails->spend_limit_duration); ?>">
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <input class="form-control" type="text" name="exp_month" placeholder="e.g. 03" minlength="2" maxlength="2" value="<?php echo e($cardDetails->exp_month); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
                                                            </div>
                                                        </div>
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <input class="form-control" type="text" name="exp_year" placeholder="e.g. 2024" minlength="4" maxlength="4" value="<?php echo e($cardDetails->exp_year); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
                                                            </div>
                                                        </div>
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                             ...
                                                             <div class="col-sm-9">
                                                                 <input class="form-control" type="text" name="cvv" placeholder="e.g. 123" minlength="3" maxlength="3" value="<?php echo e($cardDetails->cvv); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required>
                                                            </div>
                                                        </div>
