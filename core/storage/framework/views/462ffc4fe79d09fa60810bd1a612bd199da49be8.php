         ...
         <div class="card" id="edit">
          ...
          <div class="card-body">
            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                  <label class="col-form-label col-lg-3"><?php echo e(__('Date of Birth')); ?></label>
                  <div class="col-lg-9">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fa fa-envelope"></i></span>
                      </div>
                      <input type="email" name="email" class="form-control" placeholder="<?php echo e(__('Date of Birth')); ?>" value="<?php echo e(Carbon\Carbon::parse($user->dob)->format('d-M-Y')); ?>" readonly>
                    </div>
                  </div>
                </div> 
            <?php if($user->user_type == 1): ?>    
              <div class="form-group row">
                ...
                <?php if($user->account_type == 'standard'): ?>
                    <div class="form-group row">
                      <label class="col-form-label col-lg-3">SSN</label>
                      <div class="col-lg-9">
                        <input type="text" id="verify_ssn" name="verify_ssn" class="form-control" placeholder="SSN" value="<?php echo e($user->verify_ssn); ?>" <?php if($user->verify_ssn): ?> <?php echo e('readonly'); ?> <?php endif; ?>  maxlength="8">
                      </div>
                    </div>
                <?php endif; ?>
                <?php if($user->account_type == 'enterprise'): ?>
                <div class="form-group row">
                  <label class="col-form-label col-lg-3">EIN</label>
                  <div class="col-lg-9">
                    <input type="text" id="verify_ein" name="verify_ein" class="form-control" placeholder="EIN" value="<?php echo e($user->verify_ein); ?>" <?php if($user->verify_ein): ?> <?php echo e('readonly'); ?> <?php endif; ?>  maxlength="8">
                  </div>
                </div>
                <?php endif; ?>
                <?php endif; ?>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/user/profile/index.blade.php ENDPATH**/ ?>