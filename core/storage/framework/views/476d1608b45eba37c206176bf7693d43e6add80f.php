                    ...
                    <div class="card-body">
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea type="text" name="review" rows="5" class="form-control"><?php echo e($val->review); ?></textarea>
                                </div>
                            </div> 
                            <div class="form-group row">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/web-control/review-edit.blade.php ENDPATH**/ ?>