            ...
            <form role="form" action="<?php echo e(route('send.single')); ?>" method="post" id="modal-details">
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative">
                  ...
                  <input class="form-control" readonly type="number" name="amount" value="<?php echo e(number_format($link->amount,2)); ?>">
                </div>
              </div>
              <?php endif; ?>
...
<?php echo $__env->make('paymentlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/link/sc_view.blade.php ENDPATH**/ ?>