                      ...
                      <div class="card border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <select class="form-control" name="prefix">
                                ...
                                <option value="<?=$country->calling_code?>" <?=($country->iso_code == $phone_iso) ? 'selected' : ''?>><?php echo e($country->iso_code); ?> <?php echo e('('); ?><?php echo e('+'); ?><?php echo e($country->calling_code); ?><?php echo e(')'); ?></option>
                                <?php }?>
                            </select>
                                </div>
                            <div class="col-sm-5">
...
<script type="text/javascript">
  const flow = new Flow({
    ...
    user: {
      customerReference: <?php echo e($user_id); ?>
