                                                    ...
                                                    <div class="card-header">
                                                      ...
                                                      <form action="<?php echo e(route('admin.edit_virtual_card_subsription')); ?>" method="POST">
                                                       ...
                                                       <input type="hidden" name="plan_id" value="<?php echo e($planDetails->id); ?>">
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                                <?php echo e(__('Expedited Fee')); ?>(<?php echo e($currency->symbol); ?>)</label>
                                                            </div>
                                                             <div class="col-sm-9">
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-sm-3">
                                                                <?php echo e(__('Price')); ?>(<?php echo e($currency->symbol); ?>)</label>
                                                            </div>
                                                             <div class="col-sm-9">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/user/vcard_subscription.blade.php ENDPATH**/ ?>