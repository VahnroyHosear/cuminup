    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h3 class="mb-0"><?php echo e(__('All Customers')); ?></h3>
            </div>
                ...
                <table class="table table-flush" id="datatable-buttons_3434">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <!--td class="shorting_1"><span style="display:none;"><?php echo e(strtotime($val->created_at)); ?></span><?php echo e(++$k); ?>.</td-->
                            <td class="shorting_1"><span style="display:none;"><?php echo e(strtotime($val->created_at)); ?></span><a href="<?php echo e(route('user.manage', ['id' => $val->id])); ?>" class="dropdown-item" style="color:blue;"><?php echo e($val->first_name.' '.$val->last_name); ?></a></td>
                            <td><?php echo e($val->business_name); ?></td>
                            <td style="text-transform: capitalize;"><?php echo e($val->account_type); ?></td>
                            <td><?php echo e($val->email); ?></td>
                            <td><?php echo e('+'); ?><?php echo e($val->prefix); ?><?php echo e($val->phone); ?></td>
                            <td>
                                <?php if($val->account_type == 'standard'): ?>
                                    <?php echo e($val->verify_ssn); ?>

                                <?php else: ?>  
                                    <?php echo e($val->verify_ein); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/admin/user/index.blade.php ENDPATH**/ ?>