        ...
        <div class="">
          <div class="card-body">
            <div class="text-right">
              <a data-toggle="modal" data-target="#create-plan" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> <?php echo e(__(' Create Subscription Plan')); ?></a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="card-body">
                    <form action="<?php echo e(route('submit.plan')); ?>" method="post" id="modal-details">
                      <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12"><?php echo e(__('Subscription Validity')); ?></label>
                            <div class="col-lg-12">
        ...
        <table class="table table-flush" id="datatable-buttons">
          <thead>
            <tr>
              ...
              <th class="scope"><?php echo e(__('Payment URL')); ?></th>  
              <th class="scope"><?php echo e(__('Action')); ?></th>  
            </tr>
          </thead>
          <tbody>  
              ...
              <tr>
                  ...
                  <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              ...
                              <?php if($val->active==1): ?>
                               <a class='dropdown-item' href="<?php echo e(url('user/unplan')); ?>/<?php echo e($val->id); ?>"><?php echo e(__('Disable')); ?></a>
        ...
        <?php else: ?>
         <center><div class="col-md-12">
              <br>
                ...
                <p class="text-center card-text mt-4"><?php echo e(__('No plan found!')); ?></p>
               <h3>Let’s Create your first Plan</h3>
             <a data-toggle="modal" data-target="#create-plan" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i>  <?php echo e(__('Get Started')); ?></a>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/plans/index.blade.php ENDPATH**/ ?>