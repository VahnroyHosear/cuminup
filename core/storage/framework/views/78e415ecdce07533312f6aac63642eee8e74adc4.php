  ...
  <div class="content-wrapper">
    <div class="card">
          ...
          <tbody>  
            <?php $__currentLoopData = $donation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><?php if($val->sender_id==$user->id || $val->charge==null): ?> - <?php else: ?> <?php echo e($currency->symbol.number_format($val->charge,2)); ?> <?php endif; ?></td>
      ...
      <center>
           <div class="col-lg-12">
              <br>
                <p class="text-center card-text mt-5"><?php echo e(__('No donation log Found!')); ?></p>
               <h3><?php echo e(__('Let’s Create your first donation page')); ?></h3>
             <a href="<?php echo e(url('user/dp-links')); ?>" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> <?php echo e(__('Get Started')); ?></a>
