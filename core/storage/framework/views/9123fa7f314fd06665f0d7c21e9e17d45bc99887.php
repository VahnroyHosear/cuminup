				...
				<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td style="padding: 0 2.5em; text-align: left;">
							<div class="text">
								<h4>Hello, <?php echo $sender_name; ?></h4>
								<h4><?php echo $sender_text; ?></h4>
							</div>
						</td>
					</tr>
				</table>
				...
				<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
							<div class="text">
							    <?php 
							        $product_detail = DB::table('products')->where('id', $product_id)->orderBy('created_at', 'desc')->first();
							        //dd($product_detail);
							    ?>
			...
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
						<span style="font-size: 12px;">Product Price</span>
					</td>
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo e($amount); ?></span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo e($shipping_fee); ?></span>
					</td>
				</tr>
				<tr>
					...
					<td valign="middle" width="80%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo e($product_detail->name); ?></span>
					</td>
				</tr>
				<tr>
					<td valign="middle" width="20%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="80%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo $product_detail->description; ?></span>
					</td>
				</tr>
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo e($quantity); ?></span>
					</td>
				</tr>								
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo e($method); ?></span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="20%" style="text-align:left; padding: 1em 2.5em;">
				...
				<tr>
					<td valign="middle" width="20%" style="text-align:left; padding: 1em 2.5em;">
						<span style="font-size: 12px;">Tracking URL</span>
					</td>
					<td valign="middle" width="80%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo $track_url; ?></span>
					</td>
				</tr>
			</table>
		</tr>
...
</html><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/emails/product/spmail.blade.php ENDPATH**/ ?>