...
<div class="container-fluid mt--6">
  ...
  <div class="row">
    ...
    <center><div class="col-md-12 text-center">
        <br>
              <p class="text-center text-muted card-text mt-4"><?php echo e(__('You have not added any bank account yet!')); ?></p>
               
             <a  data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i>  <?php echo e(__('Add Bank Account')); ?></a>
             <br>
             <br>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/bank/index.blade.php ENDPATH**/ ?>