            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h2 class="card-title text-center"><?php echo e(__('Step 1: Choose Your Card Type')); ?></h2>
    ...
    <div class="col-md-4">
        <div class="card">
          ...
          <div class="row" style='margin-bottom: -24px;'>
            <div class="col-sm-6">  
          <h3 style="font-size: 15px;"><?php echo e($productDetails->name); ?></h3>
          </div>
          <div class="col-sm-6"> 
          <a  href="<?php echo e(route('user.instant_issue_designs', ['id' => $productDetails->id])); ?>" class="btn btn-success" style="background-color:#1d0d44;margin-top: -8px;">Get Started<!--i class="fa fa-arrow-right" aria-hidden="true"></i-->
</a>
          </div>
          </div>
          <hr>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/instantissue/index.blade.php ENDPATH**/ ?>