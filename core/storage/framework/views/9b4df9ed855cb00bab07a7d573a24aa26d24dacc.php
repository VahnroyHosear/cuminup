                            ...
                            <tbody>
                                <?php $__currentLoopData = $AllphysicalCardList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($currency->symbol.number_format($details->shipping_charge,2)); ?></td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/admin/user/physical_virtualcards.blade.php ENDPATH**/ ?>