    ...
    <div class="card">
      ...
      <div class="table-responsive py-4">
        <table class="table table-flush" id="datatable-buttons">
          ...
          <tbody>  
            <?php $__currentLoopData = $single; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e(++$k); ?>.</td>
      ...
      <center>
           <div class="col-lg-12">
              <br>
                <p class="text-center card-text mt-5"><?php echo e(__('No single charge Found!')); ?></p>
               <h3><?php echo e(__('Let’s Create your first single charge')); ?></h3>
             <a href="<?php echo e(url('user/sc-links')); ?>" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> <?php echo e(__('Get Started')); ?></a>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/user/transactions/single.blade.php ENDPATH**/ ?>