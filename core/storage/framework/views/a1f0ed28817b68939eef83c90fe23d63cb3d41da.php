                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('admin.charges.update')); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-form-label col-lg-2"><?php echo e(__('Physical Card')); ?><span class="text-danger">*</span></label>
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                            <span class="input-group-prepend">
                                                <span class="input-group-text"><?php echo e($currency->symbol); ?></span>
                                            </span>
                                            <input type="number" name="physical_card" value="<?php echo e($set->physical_card); ?>" class="form-control" required>
                                        </div>
                                    </div>
                                </div>                    
                                    <div class="text-right">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>