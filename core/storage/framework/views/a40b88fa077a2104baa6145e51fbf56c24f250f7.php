...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
		...
		<tr style="padding: 2em 0 2em 0;">
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">				
				<tr>
					<td valign="middle" width="40%" style="text-align:left; padding: 1em 2.5em;">
						<span style="font-size: 12px;">Requested Amount</span>
					</td>
					<td valign="middle" width="60%" style="text-align:right; padding: 1em 2.5em;">
	...
	<tr style="padding: 2em 0 2em 0;">	
			...
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">				
				<tr>
					<td>	<center><a class="btn btn-primary" href="<?php echo e(route('send.pay', ['id' => $confirm])); ?>" style="margin-bottom: 21px;">Click here  to make payment</a></center></td>
				</tr>				
			</table>
	</tr>
	</br>
...
</html><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/emails/request/new.blade.php ENDPATH**/ ?>