			...
			<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo $plan_name; ?></span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo date("h:i:A j, M Y", strtotime($next)); ?></span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
					...
					<td valign="middle" width="40%" style="text-align:right; padding: 1em 2.5em;">
						<span class="price" style="color: #000; font-size: 12px;"><?php echo $renewal; ?></span>
					</td>
				</tr>				
				<tr>
					<td valign="middle" width="60%" style="text-align:left; padding: 1em 2.5em;">
...
</html><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/emails/subscription/sender/new.blade.php ENDPATH**/ ?>