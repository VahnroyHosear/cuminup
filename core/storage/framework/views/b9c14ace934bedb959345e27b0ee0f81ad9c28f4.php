...
Facebook| Amazon | Online Ads | Gifts Card | Shopping & much more"></h6>
                <h1 class="display-4 m-20px-b" style="color:white!important;font-size: 46px;"><?php echo e($ui->header_title); ?></h1>
                <!--<h1 class="display-4 m-20px-b" style="color:white!important;font-size: 46px;">Simplify Your Online Businesses</h1>-->
                <p class="font-2" style="color: white;"><?php echo e($ui->header_body); ?></p>
                <div class="p-20px-t">
            ...
            <div class="col-lg-6 m-50px-tb lg-m-0px-t text-center">
                <!--<img class="max-width-140" src="<?php echo e(url('/')); ?>/asset/images/<?php echo e($ui->s4_image); ?>" title="" alt="">-->
                <img class="max-width-140" src="<?php echo e(asset('asset/images/section3_1626342935.png')); ?>" title="" alt="">
        ...
        <div class="owl-carousel owl-loaded owl-drag" data-items="7" data-nav-dots="false" data-md-items="6" data-sm-items="5" data-xs-items="4" data-xx-items="3" data-space="30" data-autoplay="true">
            <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brands): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p8">
                    ...
                    <!--<img src="<?php echo e(asset('asset/brands/')); ?>/<?php echo e($brands->image); ?>" title="" alt="">-->
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<p style="font-size: 18px;font-weight: bold;"><img src="https://cuminup.com/asset/images/credit-card (3).png" alt="" title="" style="width: 40px;margin-left: 30px;"><br> Payment url (No Web/App) </p>
                ...
                <div class="col-sm-4">
                   <p style="font-size: 18px;font-weight: bold;"><img src="https://cuminup.com/asset/images/backup.png" alt="" title="" style="width: 45px;margin-left: 30px;"><br> <?php echo e(__('Subscription')); ?></p>
                </div>
                <div class="col-sm-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/front/index.blade.php ENDPATH**/ ?>