...
.form-error-msg{
              ...
              <ul class="nav nav-tabs login-mobile-rep">
                  ...
                  <li class="or"><?php echo e(__('OR')); ?></li>
              ...
              <div id="phonetab" class="tab-pane fade active show" style="    background: #f7fafc;">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <?php $countries =DB::table('countries')->get(); ?>
                            <select class="form-control" name="prefix" style="max-width: 80px;">
                                ...
                                <option value="<?=$country->id?>" <?=($country->iso_code =='US') ? 'selected' : ''?>><?php echo e($country->name); ?> <?php echo e('('); ?><?php echo e('+'); ?><?php echo e($country->calling_code); ?><?php echo e(')'); ?></option>
                                <?php }?>
                            </select>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="<?php echo e(__('Phone')); ?>" type="text" step="any" name="phone" maxlength="13" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                  </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative input-container2">
                    ...
                    <input id="inputPassword" class="form-control" placeholder="<?php echo e(__('Password')); ?>" type="password" name="password" required>
               ...
               <div class="form-group text-center">
                  ...
                  <center> <span>  <?php echo app('captcha')->display(); ?> </span></center>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-success my-4 text-uppercase logins" style="    margin-top: 0.5rem !important;    margin-bottom: 0.5rem !important;"><?php echo e(__('Login')); ?></button>
                </div>
                <div class="row mt-3">
                  <div class="col-6">
                    <a href="<?php echo e(route('user.password.request')); ?>" class="text-dark" style="text-decoration: underline;"><small><?php echo e(__('Forgot password?')); ?></small></a>
                  </div>
                  <div class="col-6 text-right">
                    <a href="<?php echo e(route('register')); ?>" class="text-dark" style="text-decoration: underline;color:green;"><small style="color:green;"><?php echo e(__('Create an account')); ?></small></a>
                  </div>
                </div>
              </form>
              </div>
               ...
               <center> <span>  <?php echo app('captcha')->display(); ?> </span></center>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-success text-uppercase logins"><?php echo e(__('Login')); ?></button>
                </div>
                <div class="row mt-3">
                  <div class="col-6">
                    <a href="<?php echo e(route('user.password.request')); ?>" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small><?php echo e(__('Forgot password?')); ?></small></a>
                  </div>
                  <div class="col-6 text-right">
                    <a href="<?php echo e(route('register')); ?>" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small style="color:green;"><?php echo e(__('Create an account')); ?></small></a>
                  </div>
                </div>
              </form>
              </div>
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views//auth/login.blade.php ENDPATH**/ ?>