            ...
            <div class="row align-items-center " style="padding-bottom: 20px;">
                ...
                <div class="col-lg-3 col-sm-3">
                    <?php if($created_vcards_limit->cvard_limit < 0  && Auth::user()->user_type == 1): ?>      
                        <a href="<?php echo e(url('user/instant_issue')); ?>" class="btn btn-sm btn-neutral" style="background: #1937e4; padding: 7px 15px; color: #ffffff;"><i class="fa fa-plus"></i> Purchase Plan for Cards</a>
                ...
                <div class="col-lg-3 col-sm-3">
                    <b style="color: #1937e4; text-decoration: underline;"><?php echo e(__('Remaining Cards:')); ?> <?php echo e($created_vcards_limit->cvard_limit); ?></b>
                </div> 
            </div>
        </center>
                  ...
                  <div class="card-body">
                    <form method="post" action="<?php echo e(route('user.create_new')); ?>">
                        ...
                        <div class="col-lg-12">
                            <center>
                                <div style="padding:10px;">
                                    <p class="text-center"><?php echo e($currency->symbol); ?><span id="demo"></span>.00</p>
                                </div>
                            </center>
                      ...
                      <div class="form-group row" id="card_type_div_id" style="display:none;">
                        ...
                        <div class="col-lg-12">
                          <span style="font-size:12px;"><b>Note: Addtional <?php echo e($currency->symbol.number_format($set->physical_card,2)); ?> shipping charges will apply.</b></span>
                        </div>
                      </div>                 
                      <div class="text">
        ...
        <div class="row" id="allcard_div_id">
            <?php $__currentLoopData = $virtualCardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="row" style="margin-top:5px;">
                       ...
                       <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(15px, 20px, 0px);">
                            ...
                            <?php if($cardDetails->pin_generate == 0): ?>
                                <a data-toggle="modal" data-target="#createpin-model<?php echo e($cardDetails->id); ?>" href="" class="dropdown-item"><i class="fa fa-thumb-tack "></i>Generate Pin</a>
                            <?php endif; ?>
                            <a data-toggle="modal" data-target="#reissue-card<?php echo e($cardDetails->id); ?>" href="" class="dropdown-item"><i class="fa fa-credit-card "></i>Apply for New Card</a>
             ...
             <?php if($cardDetails->card_state == 'OPEN'): ?> <span class="badge badge-pill badge-success"><?php echo e('Active'); ?></span>
                ...
                <div class="modal fade" id="createpin-model<?php echo e($cardDetails->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                  <div class="modal-dialog modal- modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body p-0">
                        <div class="card bg-white border-0 mb-0">
                          <div class="card-header">
                            <h3 class="mb-0 font-weight-bolder">Generate Pin</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"><i class="fa fa-times"></i></span>
                            </button>
                            <h3>Are you sure you want to create Pin ?</h3>
                          </div>
                          <div class="card-body">
                            <form method="post" action="<?php echo e(route('user.createpin')); ?>">
                                <?php echo csrf_field(); ?>
                            
                                <input type="hidden" name="card_token" value="<?php echo e($cardDetails->token); ?>"> 
                                
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-12">Secret Pin</label>
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            <input type="number" name="secret_pin" class="form-control" minlength="4" maxlength="12" required="">
                                        </div>
                                    </div>
                                </div
                ...
                <div class="modal fade" id="reissue-card<?php echo e($cardDetails->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                  <div class="modal-dialog modal- modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body p-0">
                        <div class="card bg-white border-0 mb-0">
                          <div class="card-header">
                            <h2 class="mb-0 font-weight-bolder">Apply for a new card</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true" style="margin-top: -25px;"><i class="fa fa-times"></i></span>
                            </button>
                            <!--p class="form-text text-xs">Card creation charge is 5.7% of amount entitled to card. Maximum cash a card can hold is USD10,000.</p-->
                          ...
                          <div class="card-body">
                            <form method="post" action="<?php echo e(route('user.reissue_card')); ?>">
                                <?php echo csrf_field(); ?>
                              <input type="hidden" name="card_token" value="<?php echo e($cardDetails->token); ?>">                 
                              <div class="text-center">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/user/physicalcard/index.blade.php ENDPATH**/ ?>