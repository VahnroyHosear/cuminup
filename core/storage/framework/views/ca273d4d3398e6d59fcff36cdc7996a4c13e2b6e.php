...
if(!empty(Auth::id() == 1))
{ 
    $notification = DB::table('notification')->where(['receiver_id'=>Auth::id(),'read_status_for_receiver'=>0])->orderBy('id','DESC')->get();
}
?>
  ...
  <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-dark bg-cyan" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        <!-- Collapse -->
        <?php if(Auth::guard('admin')->user()->username == 'seovirtualcard'): ?>
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <hr class="my-3">
                <h6 class="navbar-heading p-0 text-muted"><?php echo e(__('SEO Details')); ?></h6>
        ...
        <?php else: ?>
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
              ...
              <ul class="navbar-nav mb-md-3"> 
                ...
                <li class="nav-item">
                  <a class="nav-link <?php if(route('admin.enterprise_pending')==url()->current()): ?> active <?php endif; ?>" href="<?php echo e(route('admin.enterprise_pending')); ?>">
                    <i class="fa fa-user"></i>
                    <span class="nav-link-text"><?php echo e(__('Enterprise Pending Request')); ?></span>
                  </a>
                </li>
                <?php endif; ?>         
                <?php if($admin->id==1): ?>    
              ...
              <li class="nav-item">
                  <a class="nav-link <?php if(route('admin.virtual_cards')==url()->current() || route('admin.virtual_cards_transactions')==url()->current() || route('admin.vcard_orders')==url()->current() || route('admin.vcard_orders')==url()->current()): ?> active <?php endif; ?>" href="#card7676" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                  ...
                  <div class="collapse <?php if(route('admin.virtual_cards')==url()->current() || route('admin.virtual_cards_transactions')==url()->current() || route('admin.vcard_orders')==url()->current()): ?> show <?php endif; ?>" id="card7676">
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item <?php if(route('admin.virtual_cards')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.virtual_cards')); ?>" class="nav-link"><?php echo e(__('Virtual Card Users List')); ?></a></li>
                     <li class="nav-item <?php if(route('admin.vcard_orders')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.vcard_orders')); ?>" class="nav-link"><?php echo e(__('vCard Orders List')); ?></a></li>
                      ...
                      <li class="nav-item <?php if(route('admin.physical_virtual_card')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.physical_virtual_card')); ?>" class="nav-link"><?php echo e(__('Physical Card Users')); ?></a></li>
                ...
                <li class="nav-item">
                  <a class="nav-link <?php if(route('admin.subscription_list')==url()->current() || route('admin.subscription_list')==url()->current() || route('admin.deposit.log')==url()->current()): ?> active <?php endif; ?>" href="#card77778" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                    <i class="fa fa-inr"></i>
                    <span class="nav-link-text"><?php echo e(__('Virtual Card Setting')); ?>
                  ...
                  <div class="collapse <?php if(route('admin.subscription_list')==url()->current() || route('admin.subscription_list')==url()->current() || route('admin.card_type_list')==url()->current() || route('admin.card_design_list')==url()->current()): ?> show <?php endif; ?>" id="card77778">
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item <?php if(route('admin.subscription_list')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.subscription_list')); ?>" class="nav-link"><?php echo e(__('Subscription Type')); ?></a></li>
              ...
              <ul class="navbar-nav mb-md-3"> 
                ...
                <?php if($admin->id==1): ?>
                <li class="nav-item">
                  <a class="nav-link  <?php if(route('homepage')==url()->current() || route('admin.service')==url()->current() || route('admin.brand')==url()->current() || route('admin.logo')==url()->current() || route('admin.review')==url()->current() || route('admin.page')==url()->current() || route('admin.faq')==url()->current() || route('admin.currency')==url()->current() || route('admin.terms')==url()->current() || route('privacy-policy')==url()->current() || route('about-us')==url()->current() || route('social-links')==url()->current() || route('e-sign')==url()->current()): ?> active <?php endif; ?>" href="#xx" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
                    <i class="fa fa-desktop"></i>
                    <span class="nav-link-text"><?php echo e(__('Website design')); ?></span>
                  </a>
                  <div class="collapse <?php if(route('homepage')==url()->current() || route('admin.service')==url()->current() || route('admin.brand')==url()->current() || route('admin.logo')==url()->current() || route('admin.review')==url()->current() || route('admin.page')==url()->current() || route('admin.faq')==url()->current() || route('admin.currency')==url()->current() || route('admin.terms')==url()->current() || route('privacy-policy')==url()->current() || route('about-us')==url()->current() || route('social-links')==url()->current() || route('e-sign')==url()->current()): ?> show <?php endif; ?> " id="xx">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item <?php if(route('homepage')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('homepage')); ?>" class="nav-link"><?php echo e(__('Homepage')); ?></a></li>
                        <li class="nav-item <?php if(route('admin.brand')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.brand')); ?>" class="nav-link"><?php echo e(__('Brands')); ?></a></li>	
                        <li class="nav-item <?php if(route('admin.logo')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.logo')); ?>" class="nav-link"><?php echo e(__('Logo & Favicon')); ?></a></li>	
                        ...
                        <li class="nav-item <?php if(route('admin.page')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.page')); ?>" class="nav-link"><?php echo e(__('Webpages')); ?></a></li>
                        <li class="nav-item <?php if(route('admin.faq')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.faq')); ?>" class="nav-link"><?php echo e(__('FAQs')); ?></a></li>
                        <li class="nav-item <?php if(route('admin.country')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.country')); ?>" class="nav-link"><?php echo e(__('Country')); ?></a></li>
                        <li class="nav-item <?php if(route('admin.currency')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.currency')); ?>" class="nav-link"><?php echo e(__('Currency')); ?></a></li>
                        <li class="nav-item <?php if(route('admin.terms')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('admin.terms')); ?>" class="nav-link"><?php echo e(__('Terms & Condition')); ?></a></li>
                        <li class="nav-item <?php if(route('privacy-policy')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('privacy-policy')); ?>" class="nav-link"><?php echo e(__('Privacy policy')); ?></a></li>
                        <li class="nav-item <?php if(route('about-us')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('about-us')); ?>" class="nav-link"><?php echo e(__('About us')); ?></a></li>
                        <li class="nav-item <?php if(route('social-links')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('social-links')); ?>" class="nav-link"><?php echo e(__('Social Links')); ?></a></li>   
                        <li class="nav-item <?php if(route('e-sign')==url()->current()): ?> active <?php endif; ?>"><a href="<?php echo e(route('e-sign')); ?>" class="nav-link"><?php echo e(__('e-Sign Consent')); ?></a></li>   
                ...
                <li class="nav-item">
                  <a class="nav-link <?php if(route('admin.seo')==url()->current()): ?> active <?php endif; ?>" href="<?php echo e(route('admin.seo')); ?>">
                    <i class="fa fa-share"></i>
                    <span class="nav-link-text">SEO Details</span>
                  </a>
                </li> 
                <li class="nav-item">
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-auto ml-md-0">
             ...
             <li class="nav-item dropdown"> <a href="<?php echo e(url('admin/ticket')); ?>"><i class="fa fa-question-circle" style="font-size:26px;cursor:poniter" aria-hidden="true"></i></a></li>
            <li class="nav-item dropdown">
                
               
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-bell" style="color:#256377"></i> <span class="badge badge-sm badge-circle badge-floating badge-danger border-white"> <?php echo e(count($notification)); ?></span></a>
                ...
                <!--div class="dropdown-menu" style="height: 200px;    overflow-y: scroll;">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('user.manage', ['id' => $kyc->id])); ?>" target="_blank"><?php echo e($kyc->first_name); ?> <?php echo e($kyc->last_name); ?> <br><span style="color:green">Requested for enterprise account.</span>  </a>
                ...
                <div class="dropdown-menu" style="height: 200px;    overflow-y: scroll;">
                    <?php $__currentLoopData = $notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notify_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <?php echo e($notify_details->receiver_description); ?>  
                    </br>
...
<?php /**PATH /home/cuminup/public_html/core/resources/views/master.blade.php ENDPATH**/ ?>