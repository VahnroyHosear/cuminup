        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="#" data-toggle="modal" data-target="#donation-details" class="btn btn-link px-2" style="color:white;">Read more</a>
                                ...
                                <div class="modal-body p-0">
                                    <div class="card bg-white border-0 mb-0">
                                        <div class="card-header">
                                            <h3 class="mb-0"><?php echo e($link->name); ?> <button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                                        </div>
          ...
          <div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body">
                <div class="row justify-content-between align-items-center mb-3">
                    <div class="col-8">
                        <span class="form-text text-xl"><?php echo e($currency->symbol); ?> <?php echo e(number_format($link->amount,2)); ?> Goal</span>
                    </div>
                    <div class="col-4 text-right">  
                        <?php if($donated<$link->amount): ?> 
                        <?php if(!empty(Auth::guard('user')->user()->id)): ?>
                            <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#donation-page"><?php echo e(__('Donate Now')); ?></a>
                        <?php else: ?>
                        <a href="<?php echo e(url('login')); ?>" class="btn btn-sm btn-success"><?php echo e(__('Login to Donate')); ?></a>
                        <?php endif; ?>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card bg-white border-0 mb-0">
                                    <div class="card-header">
                                        <h3 class="mb-0"><?php echo e(__('Contribute to this project')); ?><button type="button" class="close" style="float:right" data-dismiss="modal">&times;</button></h3>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="amount" id="xx" placeholder="0.00" maxlength="10" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                                ...
                                                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                                    ...
                                                                    <form action="<?php echo e(route('send.donation')); ?>" role="form" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e($stripe->val1); ?>" id="payment-form">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-12 form-group required">
                                                                            <input type="text" class="form-control input-lg custom-input" name="cardNumber" placeholder="*Debit/Credit Card Number" minlength="16" maxlength="16" autocomplete="off" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" required autofocus size="20"/>
                                                                        </div>                                  
                                                                        <div class="col-xs-12 col-md-12 form-group required">
                                                                        ...
                                                                        <div class='col form-group cvc'>
                                                                            <input autocomplete='off' class='form-control card-cvc' name="cardCVC" placeholder='*CVC' type='text' minlength="3" maxlength="3"  required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                                        </div>
                                                                        <div class='col form-group expiration required'>
                                                                            <input class='form-control card-expiry-month' name="cardM" placeholder='*MM' minlength="2" maxlength='2' type='text' required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                                        </div>
                                                                        <div class='col form-group expiration required'>
                ...
                <div class="row justify-content-between align-items-center mb-3">
                    <div class="col-8">
                        <span class="form-text text-md text-dark"><?php echo e($currency->symbol); ?> <?php echo e(number_format($donated,2)); ?> raised</span>
                    </div>
                </div>  
              ...
              <ul class="list-group list-group-flush list my--3">
                <?php $__currentLoopData = $paid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row align-items-center">
                        ...
                        <small><?php echo e($currency->symbol.number_format($val->amount,2)); ?> @ <?php echo e(date("h:i:A j, M Y", strtotime($val->created_at))); ?></small>
                        </div>
                    </div>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('paymentlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/link/dp_view.blade.php ENDPATH**/ ?>