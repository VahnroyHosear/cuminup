    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('light.logo')); ?>" enctype="multipart/form-data" method="post">
                        <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0"><?php echo e(__('Dark mode')); ?></h3>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('dark.logo')); ?>" enctype="multipart/form-data" method="post">
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <div class="custom-file">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid" src="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->dark); ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/web-control/logo.blade.php ENDPATH**/ ?>