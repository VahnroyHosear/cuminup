            ...
            <div class="modal-content">
                ...
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="text" name="occupation" class="form-control" placeholder="<?php echo e(__('Occupation')); ?>" required>
                            </div>
                        </div>                         
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <textarea type="text" name="review" class="form-control" placeholder="<?php echo e(__('Review')); ?>" rows="5" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/admin/web-control/review.blade.php ENDPATH**/ ?>