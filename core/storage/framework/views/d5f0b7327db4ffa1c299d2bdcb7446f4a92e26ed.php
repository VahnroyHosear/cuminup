            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h2 class="card-title text-center"><?php echo e(__('Step 3: Select Quantity')); ?></h2>
                        
                    </div>
 <div class="row"> 
 <div class="col-md-2"></div>
<div class="col-md-6">
   <center><h3 style="padding: 15px;margin-right: -30%;"><?php echo e(__('How many card would you like?')); ?></h3></center>
 ...
 <label><input type="radio" name="colorRadio" style="-webkit-appearance:auto!important;margin-left:20px" id="radio<?php echo e($planDetails->id); ?>" value="<?php echo e($planDetails->id); ?>" <?php if($k == 0): ?> <?php echo e('checked'); ?> <?php endif; ?>> <?php echo e($planDetails->plan_quantity); ?> <?php echo e(__('Cards')); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($currency->symbol.number_format( $planDetails->plan_price)); ?>.00</label>
 ...
 <!--label><input type="radio" name="colorRadio" style="-webkit-appearance:auto!important;margin-left:20px" id="radio" value="custom">  <?php echo e(__('Custom Card Quantity')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" id="custom_input" size="4" style="width:60px;" value="2"></label-->
    ...
    <div class="<?php echo e($planDetails->id); ?> box" style="display:none;padding: 15px;">
       <center><h4 style="margin-right: -30%;"> Order Summary </h4></center>
<h5>Product Type (<?php echo e($productType_details->name); ?>)</h5>
    ...
    <li><b>Total Cost:	<?php echo e($currency->symbol.number_format($planDetails->plan_price+$planDetails->plan_expedited_fee,2)); ?> </b></li>
    <li><?php echo e(__('Description:')); ?> <?php echo $planDetails->plan_features; ?></li>
                 <center><a  href="<?php echo e(url('user/complete_order/'.$product_type_id.'/'.$design_id.'/'.$planDetails->id)); ?>" class="btn btn-success" style="margin-right: -50%;font-size: 20px;">Complete Order | <i class="fa fa-arrow-right" aria-hidden="true"></i></a></center>
<br>
        </div>
    ...
    <div class="default box" style="padding: 15px;">
         <?php $__currentLoopData = $allplans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $planDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <?php if($k==0): ?>
       <center><h3 style="margin-right: -30%;"> Order Summary</h3></center>
<h5>Product Type (<?php echo e($productType_details->name); ?>)</h5>
       <li>Quantity :	<?php echo e($planDetails->plan_quantity); ?> </li>
    <li> Expedited Fee :	<?php echo e($currency->symbol.number_format($planDetails->plan_expedited_fee,2)); ?> </li>
     <li>Card Fee:	<?php echo e($currency->symbol.number_format($planDetails->plan_price,2)); ?> </li>
...
<br>
    ...
    <!--div class="default box" style="display:none;padding: 15px;">
       <h4 style="margin-right: -30%;"> Order Summary and Confirmation </h4>
        <h5>Product Type ( Payout Card)</h5>
                ...
                <li>Total Cost:	<?php echo e($currency->symbol); ?><span id="custom_field_price"></span>.00 </li>
                             <center><a  href="<?php echo e(url('user/complete_order/'.$product_type_id.'/'.$design_id.'/0')); ?>" class="btn btn-success" style="margin-right: -50%;font-size: 20px;">Complete Order | <i class="fa fa-arrow-right" aria-hidden="true"></i></a></center>
            <br>
    </div>
        
    <div class="custom box" style="padding: 15px;">
               <h4 style="margin-right: -30%;"> Order Summary and Confirmation </h4>
        <h6>Product Type ( Payout Card)</h6>
               <li>Quantity :	2 </li>
            <li> Expedited Fee :	$0.00 </li>
            <li>Total Cost:	<?php echo e($currency->symbol); ?>6.00 </li>
                        <center> <a  href="<?php echo e(url('user/complete_order/'.$product_type_id.'/'.$design_id.'/-1')); ?>" class="btn btn-success" style="margin-right: -50%;font-size: 20px;">Complete Order | <i class="fa fa-arrow-right" aria-hidden="true"></i></a></center>
        <br>
    </div-->
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/instantissue/product_quantity.blade.php ENDPATH**/ ?>