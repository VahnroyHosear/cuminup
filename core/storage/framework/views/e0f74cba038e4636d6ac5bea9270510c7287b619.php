                         ...
                         <div class="form-group row">
                            <div class="col-xs-12 col-md-12 form-group required">
                              <div class="input-group">
                                ...
                                <input type="text" step="any" class="form-control" name="amount" id="cardamount" onchange="cardcharge()" maxlength="10" placeholder="0.00" min="<?php echo e($stripe->minamo); ?>" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"> 
      ...
      <div class="col-md-12">
        ...
        <table class="table table-flush" id="datatable-buttons">
            ...
            <?php $__currentLoopData = $transfer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><?php echo e($currency->symbol.number_format($val->amount,2)); ?></td>
                 ...
                 <td><?php if(!empty($val->receiver['email'])): ?>
          ...
          <center><div class="col-md-12">
              <br>
              <p class="text-center text-muted card-text mt-8"><?php echo e(__('No Send History Found!')); ?></p>
              <a data-toggle="modal" data-target="#modal-formx" href="#" class="btn btn-neutral"><i class="fa fa-plus"></i> <?php echo e(__('Start Sending Money')); ?></a>
...
function setSessionFunction() {
  ...
  ?>
    ...
    $(window).on('load', function() {
         <?php if(Session::has('from_dashboard')): ?>
          // 
           <?php Session::forget('from_dashboard'); ?>
        <?php endif; ?>  
    });
</script>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/transfer/send_money.blade.php ENDPATH**/ ?>