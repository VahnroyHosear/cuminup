          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-dark mb-5">
                <p><?php echo e(__('Still cannot Remember')); ?></p>
                <small>Enter your Email or Phone number to reset the password</small>
              </div>
              <script>
...
.form-error-msg{
              ...
              <li class="mobli"><button class="btn active login-btn " data-toggle="tab" href="#emailtab">Reset By Email</button></li>
                <li class="or"><?php echo e(__('OR')); ?></li>
              <li class="emaili"><button class="btn btn2 login-btn " data-toggle="tab" href="#phonetab">Reset By Phone</button></li>
            </ul>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="<?php echo e(route('login')); ?>" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small>Already have an account? <?php echo e(__('Login')); ?></small></a>
            </div>
            <div class="col-6 text-right">
              <a href="<?php echo e(route('register')); ?>" class="text-dark" style="    text-decoration: underline;
    font-weight: bold;"><small><?php echo e(__('Create an account')); ?></small></a>
            </div>
          </div>
        </div>
      </div>
...
function clickindividualSUbmitButton() {
    ...
    {
        $("#phone_err22").html('Phone number is required!'); 
    } else {
  ...
  $("#phone_err22").html(' '); 
   ...
   //alert(document.getElementById("indi_countryCallingCode").value);
    ...
    let _token   = $('meta[name="csrf-token"]').attr('content');
        ...
        { 
            $.ajax({
                url: "<?php echo e(url('/check_usermobile')); ?>",
                method: "POST",
...
$(document).ready(function(){ 
   ...
   function resendFunction() {
                    ...
                    window.recaptchaVerifier = new firebase.auth.RecaptchaVerifier('recaptcha-container222', {
                        ...
                        var cverify=window.recaptchaVerifier;
                       var sess_phone_input = "<?php echo e(Session::get('country_code')); ?><?php echo e(Session::get('phone_no')); ?>";
      ...
      if(otpinput.value.length == 0)
      {
       $('#verify_otp_error_result').html('Please enter your OTP here!');
               ...
               confirmationResult.confirm(otpinput.value).then(function(response){
                   ...
                   location.href = '<?php echo e(url('/')); ?>/user-password/reset-byphone';
