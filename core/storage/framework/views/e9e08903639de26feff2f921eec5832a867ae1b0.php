...
s1.async=true;
s1.src='https://embed.tawk.to/6090b4fe185beb22b309b54f/1f4qk66eo';
s1.charset='UTF-8';
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-197321554-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-197321554-1');
</script>
...
<footer class="dark-bg footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 m-15px-tb">
                        <h5 class="white-color footer-title">
                               <img src="<?php echo e(url('/')); ?>/asset/<?php echo e($logo->dark); ?>" title="" alt="" style="margin-top: -20px;">
                        </h5>
                       
                        <p class="white-color-light" style="font-size: 14px;">
                        <!--<?php echo e($set->title); ?>-->
                        Get Virtual Card is the leading fintech establishment providing high-quality cashless solution. We are always ready to partner with you by offering full digital finance solution.
                        </p>
                    ...
                    <div class="col-lg-3 col-6 col-sm-4 ml-lg-auto m-15px-tb" style="padding-left:30px">
                        <h5 class="white-color footer-title">
                    ...
                    <div class="col-lg-2 col-6 col-sm-4 m-15px-tb">
                        ...
                        <ul class="list-unstyled links-white footer-link-1">
                            ...
                            <li> <a href="<?php echo e(route('about')); ?>">Why GetVirtualCard</a></li>
                            <li>
                            ...
                            <li><a href="<?php echo e(route('privacy')); ?>"><?php echo e(__('Privacy Policy')); ?></a></li>
                             ...
                             <li><a href="<?php echo e(url('/security')); ?>">Security</a></li>
                              <li><a href="<?php echo e(url('/developers')); ?>">Developers</a></li>
                               <li><a href="<?php echo e(url('/cookiespolicy')); ?>">Cookies Policy</a></li>
                            <?php if(count($faq)>0): ?>
                            <li><a href="<?php echo e(url('/')); ?>#faq"><?php echo e(__('FAQs')); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div class="col-lg-3  m-15px-tb" style="padding-left:70px">
                        <h5 class="white-color footer-title">
                          Services
                        </h5>
                        <ul class="list-unstyled links-white footer-link-1">
    ...
    color: white;
    font-size: 12px;
"><strong>Disclaimers</strong>-Banking services are fully managed by SMD Webtech Limited.By continuing using the website, you confirm your agreement with the above-mentioned statements and documents. 
...
</html><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/layout.blade.php ENDPATH**/ ?>