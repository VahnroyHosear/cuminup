          ...
          <!--div class="card card-profile bg-white border-0 mb-5">
            ...
            <div class="card-body pt-7 px-5">
              ...
              <div class="text-center text-dark mb-5">
                <small><?php echo e(__('We have sent you 6 digit of verification code on your email id')); ?>, <span class="text-muted"><a href="<?php echo e(route('user.send-emailVcode')); ?>"><?php echo e(__('Resend email')); ?></a></span></small>
              </div>
           ...
           <div class="card card-profile bg-white border-0 mb-5">
                ...
                <div class="text-center text-dark mb-5">
                <?php if($admin->email_verification == 0 && $admin->mobile_verification == 1): ?>    
                <center><p><small><?php echo e(__('Please Verify Captcha')); ?></small></p></center>
                <?php endif; ?>
              </div>
              <?php if($admin->mobile_verification == 1): ?>
               <div class="card-body" style="margin-bottom: 70px;">
              <center><div id="recaptcha-container222" ></div></center>
              </div>
              <?php elseif($admin->email_verification == 1): ?> 
              
              <div class="card-body" style="margin-bottom: 70px;">
                  <form action="<?php echo e(route('user.mobile-verify')); ?>" method="POST">
                      <?php echo csrf_field(); ?>
              <div class="row">
...
<div class="modal fade" id="after_register_model2" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true" style="background:#333;">
                <div class="modal-dialog modal- modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                      ...
                      <div class="card border-0 mb-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <center><div class="text-center">
                                 <h3><?php echo e(__('Let us verify your Phone')); ?></h3> 
                             <form action="<?php echo e(route('user.mobile-update')); ?>" method="post">   
                             <?php echo csrf_field(); ?>
                                <div class="row">
                            ...
                            <select class="form-control" name="prefix">
                                ...
                                <option value="<?=$country->calling_code?>" <?=($country->calling_code == $user_phone_calling_code) ? 'selected' : ''?>><?php echo e($country->iso_code); ?> <?php echo e('('); ?><?php echo e('+'); ?><?php echo e($country->calling_code); ?><?php echo e(')'); ?></option>
                                <?php }?>
                            </select>
                                </div>
                            <div class="col-sm-5">
                                  <input type="text" name="phone" class="form-control" placeholder="Enter New Mobile Number"  value="<?php echo e($user_phone); ?>" required> 
                                </div>
                    ...
                    <div class="col-4"><input type="submit" class="btn btn-success" style="background-color:#058d2770;margin-right: -89px;padding: 5px;font-size: 12px;" value="Change Mobile No"> </div>
                           ...
                           <?php if($admin->email_verification == 1 && $admin->mobile_verification == 1): ?>
                           <center> <div class="row">
                            ...
                            <br> 
                            <?php endif; ?>
                            <?php if($admin->email_verification == 1 && $admin->mobile_verification == 0): ?>
                           <center> <div class="row">
                          ...
                          <!--center> <div class="row">
                            ...
                            <a href="<?php echo e($_SERVER['REQUEST_URI']); ?>" class="btn btn-primary" id="resend_otp_button_idd" style="display:none;margin-right: -236px;"><?php echo e(__('Resend OTP')); ?></a>
                ...
                <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
                  <div class="modal-content">
                    ...
                    <div class="col-4"><input type="submit" class="btn btn-success" style="background-color:#058d2770;margin-right: -89px;padding: 5px;font-size: 12px;" value="Update Mobile Now"> </div>
                            ...
                            <!--a href="<?php echo e(url('user-password/reset')); ?>" class="btn btn-primary">Try Again!!</a-->
 ...
 <form action="<?php echo e(route('user.mobile-verify')); ?>" method="POST" id="submit_form_idd">
     <?php echo csrf_field(); ?>
     <input type="hidden" value="<?php echo e($email_code); ?>" name="email_code">
...
$( document ).ready(function() {
          ...
          var str1 = "+";
                    ...
                    window.recaptchaVerifier = new firebase.auth.RecaptchaVerifier('recaptcha-container222', {
                        ...
                        var phoneinput;
                             phoneinput = "<?php echo e('+'); ?><?php echo e($user_phone_calling_code); ?><?php echo e($user_phone); ?>";
    ...
    function checkEmailCode(emailCode){
        if(emailCode == "<?php echo e($email_code); ?>")
        {
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/vcard/core/resources/views/user/profile/verify.blade.php ENDPATH**/ ?>