            ...
            <table class="table table-flush" id="datatable-buttons">
                <thead>
                    <tr>
                        ...
                        <th style="width:10%"><?php echo e(__('Message')); ?></th>                                                                      
                ...
                <?php $__currentLoopData = $message; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php if(!empty($val->prefix)): ?> <?php echo e('+'); ?><?php echo e($val->prefix); ?><?php echo e('-'); ?><?php endif; ?><?php echo e($val->mobile); ?></td>
                        <td><?php echo e($val->email); ?></td>
                        <td style="width:20%"><?php echo e($val->message); ?></td>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cuminup/public_html/core/resources/views/admin/user/message.blade.php ENDPATH**/ ?>